...
return array(
    ...
    "admin.jobName"                  => "役職",
    "admin.jobDesc"                  => "職務内容",
    "admin.jobNameInput"             => "役職名を入力してください",
    "admin.jobEdit"                  => "編集",
    "admin.menu.home"                => "ホーム",
    "admin.menu.dashboard"           => "概要",
    "admin.menu.dashboardTitle"      => "統計の概要",
    "admin.menu.notice"              => "通知管理",
    "admin.menu.groupMember"         => "部署およびメンバー管理",    
    "admin.menu.member"              => "部署とユーザー",    
    "admin.menu.role"                => "権限管理",
    "admin.menu.job"                 => "ジョブ管理",
    "admin.menu.auth"                => "ドキュメント権限管理",
    ...
    "admin.index.userSpace"          => "ユーザー容量",    
    "admin.index.groupSpace"         => "部署容量",    
    ...
    "admin.index.spaceUsed"          => "容量をとる",    
    "admin.index.useSpace"           => "使用容量",    
    "admin.index.usedSpace"          => "使用済みスペース",
    "admin.index.freeSpace"          => "残り容量",    
    ...
    "admin.index.accCnt"             => "リクエスト回数",
    "admin.index.accUser"            => "アクセスユーザー",
    "admin.index.serverInfo"         => "システムメッセージ",
    "admin.index.serverDisk"         => "システムディスク",
    "admin.index.serverStore"        => "クラウドストレージ",
    "admin.index.serverName"         => "サーバー名",
    "admin.index.normal"             => "正常",
    "admin.index.scoreDesc"          => "次の要因がシステムスコアに影響します。システムスコアは、システムが適切に実行されるように最適化できます。 <br/> 1.システムディスクおよびネットワークディスクストレージの残りの容量。 <br/> 2.データキャッシュ方法（redisを推奨）。 <br/> 3.phpプラットフォームのバージョン（64ビットphp7 +を推奨）。",    
    ...
    "admin.setting.help"             => "ヘルプ",
    "admin.setting.about"            => "バージョン情報",
    ...
    "admin.setting.passwordErrorLockDesc" => "パスワードを5回連続して間違えると、アカウントはロックされ、１分間ログインできなくなります。パスワードを強引に解除されるのを効果的に防ぐことができます。",
    "admin.setting.passwordRule"     => "ユーザーパスワードの強度設定",
    "admin.setting.passwordRuleDesc" => "パスワードの強度を指定すると、弱いパスワードを効果的に排除できます",
    "admin.setting.passwordRuleNone" => "制限無し",
    "admin.setting.passwordRuleStrong" => "中強度",
    "admin.setting.passwordRuleStrongMore" => "高強度",
    "admin.setting.passwordRuleNoneDesc" => "パスワードに制限はありません。",
    "admin.setting.passwordRuleStrongDesc" => "長さは6以上で、数字と英語の文字を含める必要があります。",
    "admin.setting.passwordRuleStrongMoreDesc" => "長さは 8 文字以上で、数字、英語の大文字、小文字、特殊文字の組み合わせを少なくとも 3 種類含める必要があります。",
    ...
    "admin.loginCheck.loginIpAllowDesc" => "設定後は、指定したIPのユーザーのみログインできますのでご注意ください",
    ...
    "admin.loginCheck.ipDisableDesc" => "設定後、IPアドレスの条件を満たすユーザーは、一切の操作ができなくなりますので、ご注意ください。<br/>
...
<li> IP範囲：IPは範囲内で一致します。例：192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"><b>ユーザーログイン制限の制御手順（IPおよびデバイスの制限）：</b></h5><li>ルールの優先順位に従って順番に検出します。ルールで指定されたユーザーには、現在ログインしているユーザーが含まれます。その結果、ルールが決定されます。</li><li>ユーザー部署と部署ユーザーを背面に配置し、ユーザー設定を前面に指定することをお勧めします（ドラッグアンドドロップで順序を調整します）</li>",    
    ...
    "admin.setting.thirdLoginDesc"   => "サードパーティのアカウントを介した登録、連携、ログインを許可します",
    ...
    "admin.setting.registCheckDesc"  => "登録ユーザーが正常に利用するためには、管理者が［ユーザーと部署］で確認・有効化する必要があります。",    
    ...
    "admin.setting.registReviewOpen" => "登録審査を有効化",
    "admin.setting.registRoleEmpty"  => "権限は空にできません",
    "admin.setting.registNotSync"    => "データの競合を避けるために、サードパーティのデータ同期とユーザー登録を同時に有効にすることはできません",
    "admin.setting.registNeedRewiew" => "設定後、登録ユーザーが正常に利用するためには、管理者が［ユーザーと部署］で確認・有効化する必要があります。",    
    "admin.setting.roleRight"        => "権限",
    "admin.setting.emailType"        => "メールサーバーの種類",
    "admin.setting.emailHost"        => "メールサーバー",
    "admin.setting.emailHostInput"   => "メールサーバーのアドレスを入力してください",
    "admin.setting.emailHostTips"    => "メールサーバーのアドレスを入力してください",
    "admin.setting.emailHostDesc"    => "smtp.163.comなどのメールサーバーでは、ポートをカスタマイズできます（デフォルトは465）",
    "admin.setting.emailSend"        => "送信元メールアドレス",
    ...
    "admin.setting.emailPwd"         => "認証パスワード",
    ...
    "admin.setting.emailTo"          => "受信メールアドレス",
    ...
    "admin.setting.groupListChildDesc" => "部署フォルダがサブ部署を表示するかどうかにかかわらず、権限は上位に継承されます",    
    "admin.setting.groupRootListChild" => "エンタープライズWebディスクはサブセクターをリストします",
    "admin.setting.groupRootListChildDesc" => "企業ネットワークのディスクフォルダーにサブ部署が表示され、権限が上位に継承されるかどうか",    
    "admin.setting.shareToMeAllowTree" => "私と協力する-組織構造ごとに表示",
    "admin.setting.shareToMeAllowTreeTips" => "有効後、私とのコラボレーションのコンテンツサポートは、部署の組織構造に応じて分類されており、組織構造がより複雑な状況に適しています。",    
    "admin.setting.groupTagAllow"    => "部署のパブリックラベル",    
    "admin.setting.groupTagAllowTips" => "有効にすると、部署内のファイルのパブリックラベルを設定すると、すべての部署メンバーが表示されます。部署管理者は、ラベルの内容を管理できます。",    
    "admin.setting.groupSpaceLimit"  => "部署ネットワークのディスクレベル制限",    
    "admin.setting.groupSpaceLimitTips" => "部署を超えた階層には部署ネットワークディスクは表示されません",    
    "admin.setting.groupSpaceLimitLevel" => "部署ネットワークディスクレベル",    
    "admin.setting.groupSpaceLimitLevelTips" => "レベルを指定します。デフォルトは 5 レベル以上です。部署ネットワーク ディスクは表示されません。最小値は 2 です。",    
    ...
    "admin.setting.srvStateSrv"      => "サーバーシステムのストレージ容量",    
    "admin.setting.srvStateDef"      => "ネットワークディスクのデフォルトのストレージ容量",    
    ...
    "admin.setting.myClientIp"       => "マイIP",
    "admin.setting.myClientUa"       => "マイブラウザUA",
    "admin.setting.myClientLng"      => "マイブラウザ言語",
    ...
    "admin.setting.clearDB"          => "データベース異常データクリーンアップ",    
    ...
    "admin.setting.srvCpuUse"        => "現在の使用量",
    "admin.setting.srvCpuFree"       => "未使用",
    "admin.setting.noLimit"          => "無制限",
    "admin.setting.disFunNo"         => "なし",
    ...
    "admin.setting.recDesc"          => "使用説明",
    "admin.setting.recDescInfo11"    => "この操作により、システムデータがリセットされます。非操作およびメンテナンス、または関連する技術者は操作しないでください。",    
    ...
    "admin.group.role"               => "権限アイデンティティ",
    "admin.group.name"               => "部署名",    
    "admin.group.parent"             => "上位部署",    
    "admin.group.authShow"           => "部署のメンバーに見える組織構造の範囲",    
    "admin.group.authShowAll"        => "すべての部署",    
    "admin.group.authShowHide"       => "この部署とサブ部署のみ",    
    "admin.group.authShowSelect"     => "指定部署",    
    "admin.group.authShowAllTips"    => "この部署のメンバーが協力して共有すると、他のすべての部署（およびユーザー）を選択できます",    
    "admin.group.authShowHideTips"   => "この部署のメンバーが共同作業して共有する場合、現在の部署とサブ部署（およびユーザー）のみがサポートされます",    
    "admin.group.authShowSelectTips" => "部署のメンバーが共同で共有する場合、現在の部署とサブ部署を含む、指定された部署とサブ部署（およびユーザー）を選択できます。",    
    "admin.group.addSub"             => "サブセクターを追加",
    "admin.group.remove"             => "部署を削除",    
    "admin.group.removeBatch"        => "部署を一括削除",    
    "admin.group.removeBatchDesc"    => "複数の部署を選択して一括削除することもできますので、慎重に操作してください。",    
    "admin.group.removeSub"          => "サブ部署の削除",    
    "admin.group.removeSubDesc"      => "有効にすると、すべてのサブ部署が同時に削除されます。それ以外の場合は、選択した部署のみが削除され、サブ部署は自動的に親部署に所属します。",    
    "admin.group.switch"             => "移行",
    "admin.group.swtichDesc"         => "選択した部署 (およびそのサブ部署) のユーザーとファイルをターゲット部署に移行します。",    
    "admin.group.switchSameError"    => "対象部署を選択した部署と同じにすることはできません",    
    "admin.group.switching"          => "移行中、お待ちください...",
    "admin.group.groupSwitching"     => "選択した部署が移行中です",    
    "admin.group.parentNullError"    => "上層部を空にすることはできません",
    "admin.group.selected"           => "選択した部署",    
    "admin.group.setSizeBatch"       => "容量サイズをバッチで設定する",    
    "admin.group.multiSelect"        => "複数の部署をバッチ設定用に選択できます",    
    "admin.group.ifDisAll"           => "すべてのサブ部署が無効になります。実行してもよろしいですか？",    
    "admin.group.nameErr"            => "部署名には含めることはできません",    
    "admin.member.manage"            => "ユーザーと部署",    
    "admin.member.add"               => "新しいユーザー",
    "admin.member.role"              => "権限",
    "admin.member.group"             => "部署",    
    "admin.member.groupAdd"          => "部署を追加",    
    "admin.member.groupEdit"         => "部署を編集",
    "admin.member.remove"            => "ユーザーを削除",
    "admin.member.import"            => "一括追加",
    "admin.member.enable"            => "有効にする",
    "admin.member.batchSet"          => "一括操作",
    "admin.member.groupRemove"       => "部署から削除",    
    "admin.member.groupInsert"       => "部署に追加",    
    "admin.member.groupSwitch"       => "部署に移行する",   
    "admin.member.groupTarget"       => "対象部署",    
    "admin.member.groupReset"        => "部署のリセット",    
    "admin.member.groupSwtichDesc"   => "選択したユーザーを現在の部署からターゲット部署に移行します",    
    "admin.group.setGroupOwner"      => "部署管理者の設定",    
    "admin.group.ownerAllowEditUser" => "ユーザーの編集を許可する",
    "admin.group.setGroupOwnerTips"  => "<b>部署管理者の権限:</b><br/><br/><li>ユーザーはこの部署の所有者権限を持っています</li><li>ユーザーの編集を許可すると、ユーザーの権限はデフォルトで部署管理者に設定され、バックグラウンドで部署配下のユーザーを編集したり、部署およびサブ部署を編集したりできるようになります。</li><li>解除方法：該当ユーザーを編集し、権限を一般ユーザーに変更し、ユーザーの所属部署の権限を変更します。</li>",    
    "admin.member.roleSet"           => "権限の設定",
    "admin.member.sizeSet"           => "容量サイズ設定",    
    ...
    "admin.member.uploadDataInvalid" => "アップロードされたデータは有効期限が切れています。再度送信してください。",
    ...
    "admin.member.importDisable"     => "無効化（無効化：-1、有効化：-0、または空欄）",
    "admin.member.importSizeLimit"   => "ファイルサイズが制限を超えました（[1]）。",
    "admin.member.importDownErr"     => "ファイルのダウンロードに失敗しました！",
    "admin.member.importEmpty"       => "ファイルが空です！",
    "admin.member.importAllErr"      => "有効なアカウント情報が見つかりませんでした。ご確認ください。",
    "admin.member.importPartErr"     => "アカウント情報に誤りがあります。ご確認ください。",
    "admin.member.importStart"       => "確認完了。インポートを開始します。",
    "admin.member.importGroupErr"    => "所属部署が空です",
    "admin.member.importNameErr"     => "アカウントは空です",
    "admin.member.importPwdErr"      => "パスワードは空欄です。",
    "admin.member.importGroupAuthErr" => "当該部署の権限は空です。",
    "admin.member.importSysErr"      => "システムエラー",
    "admin.member.importGroupAuthCntErr" => "部署と権限が一致しません",
    "admin.member.importGroupPathErr" => "指定された部署パスは存在しません。",
    "admin.member.importAuthErr"     => "指定された権限は存在しません。",
    "admin.member.importGroup1"      => "エンタープライズクラウドストレージ／研究開発部署／研究開発グループ2",
    "admin.member.importGroup2"      => "エンタープライズクラウドストレージ／運用保守部署",
    "admin.member.importCopyGroupTips" => "部署データを読み込み中です。しばらくしてからもう一度お試しください。",
    "admin.member.importCopyTips"    => "コピーに失敗しました。ページを更新してもう一度お試しください。",
    "admin.member.importCheckStart"  => "検査を開始する",
    "admin.member.importCheckRest"   => "検査結果",
    "admin.member.importSaveRest"    => "インポート結果",
    "admin.member.importLineNum"     => "行番号",
    "admin.member.importContinue"    => "インポートを続ける",
    "admin.member.importIDNumber"    => "身分証明書",
    "admin.member.importUserSize"    => "ユーザー空間サイズ",
    "admin.member.importUserSizeDesc" => "0は制限なしを表します",
    "admin.member.importUserRole"    => "ユーザーの役割と権限",
    "admin.member.importUserGroup"   => "ユーザー部署",
    "admin.member.importGroupSet"    => "統合設定",
    "admin.member.importGroupImport" => "インポート設定",
    "admin.member.importGroupDesc"   => "統合設定: インターフェイスで設定を選択して、インポートされたすべてのアカウントの統合された部署と権限を指定します。[0] インポート設定: テンプレートに部署と権限のフィールドを追加します。部署フィールドには部署の完全なパス (例:<code>企业网盘/研发部/研发二组</code>) が入力され、複数のフィールドは<code>;</code>で区切られます。権限フィールドには権限名が入力され、複数のフィールドも<code>;</code>で区切られます。2 つのフィールドの内容は 1 対 1 で対応します。",
    "admin.member.importCopyTool"    => "コピーツール",
    "admin.member.importCopyToolDesc" => "ボタンをクリックしてコピーウィンドウを開き、テンプレートに入力するために必要な部署のパスと権限をコピーしてください。",
    "admin.member.importCopyGroup"   => "パスをコピー",
    "admin.member.importCopyGroupDesc" => "選択した部署の完全なパスをコピーします",
    "admin.member.importCopyAuth"    => "コピー許可",
    "admin.member.importCopyAuthDesc" => "コピー権限名",
    "admin.member.importMetaMore"    => "拡張フィールド",
    "admin.member.importMetaMoreDesc" => "インポートしたファイルにカスタムフィールドを追加する",
    "admin.member.importMetaField"   => "カスタムフィールド",
    "admin.member.importMetaFieldDesc" => "携帯電話番号とメールアドレスはシステムフィールドであり、本人確認の優先順位を決定するためのソートにのみ使用されます。",
    "admin.member.importFieldName"   => "フィールド名",
    "admin.member.importFieldDisable" => "クリックして無効にする",
    "admin.member.importFieldEnable" => "クリックして有効にする",
    "admin.member.importBindField"   => "本人確認",
    "admin.member.importBindFieldDesc1" => "このクエリは、指定されたフィールドに基づいてデータを順番に照合します。既存のアカウントが見つかった場合は更新され、見つからない場合は新しいアカウントが作成されます。",
    "admin.member.importBindFieldDesc2" => "アップデート中はログインユーザー名とパスワードは更新されませんが、パスワード欄は入力する必要があります。",
    "admin.member.importType"        => "インポート方法",
    "admin.member.importType0"       => "追加インポート",
    "admin.member.importType1"       => "完全インポート",    
    "admin.member.importTypeValue"   => "無効なアカウント処理",
    "admin.member.importTypeValueDesc" => "完全インポート中に、現在インポート中のファイルに存在しないアカウントを処理します。",
    "admin.member.importChangeGroup" => "部署へ移行する",
    "admin.member.importFile"        => "ファイルのインポート",
    "admin.member.importFileDesc"    => "テンプレートファイルを所定の形式に従って記入し、対応するディレクトリにアップロードしてください。注：テンプレートの形式は設定によって変更される場合があります。",
    "admin.member.selectCsv"         => "インポートするCSVファイルを選択してください。",
    "admin.member.importDownData"    => "現在をエクスポート",
    "admin.member.importDownDataDesc" => "現在のアカウントすべてをテンプレート形式でエクスポートします",
    "admin.member.groupRemoveTips"   => "削除後、部署ファイルはシステムのごみ箱に移動されます。続行してもよろしいですか?",    
    "admin.member.memberRemoveTips"  => "削除後、ユーザー ファイルはシステムのごみ箱に移動されます。続行してもよろしいですか?",
    "admin.member.freeGroupRemoveTips" => "削除後、部署ファイルも削除されます。続行してもよろしいですか?",    
    ...
    "admin.member.space"             => "ユーザー容量サイズを設定する",    
    "admin.member.spaceTips"         => "0は制限されていません",
    "admin.member.spaceTipsDefault"  => "（GB）0は制限されません",
    "admin.member.spaceTipsFull"     => "制限なし",
    "admin.member.spaceSize"         => "ユーザー容量",
    "admin.member.spaceSizeUse"      => "容量使用",    
    "admin.member.mySpaceSize"       => "マイスペースのサイズ",
    "admin.member.memberAdd"         => "ユーザーを追加",
    "admin.member.allAdd"            => "ユーザーまたは部署を追加",    
    ...
    "admin.member.searchGroup"       => "検索部署（ピンインとあいまい一致のサポート）",    
    "admin.member.searchAll"         => "ユーザーまたは部署の検索（ピンインとあいまい一致のサポート）",    
    "admin.member.editNoAuth"        => "申し訳ありませんが、この権限はありません。 <br/>システム管理者のみがシステム管理者を追加および変更できます",
    "admin.member.disabledUsers"     => "アカウントが無効になっています",
    "admin.member.disabledTips"      => "部署を切り替えてチェックを外します",    
    "admin.member.userGroup"         => "ユーザー部署",    
    "admin.member.userRole"          => "ユーザー権限",
    "admin.member.userSelected"      => "選択したユーザー",
    "admin.member.authCopy"          => "部署の権限をコピーする",    
    "admin.member.authPaste"         => "部署権限ペースト",    
    "admin.member.ifAuthPaste"       => "コピーした部署の権限を現在のユーザーに設定してもよろしいですか？",    
    "admin.member.errEditSelfRole"   => "自分自身の権限の変更はサポートされていません",
    "admin.member.errEditAdminRole"  => "管理者の権限を変更する権限がありません",
    ...
    "admin.role.displayDesc"         => "ユーザー権限を設定するときに表示するかどうか",
    "admin.role.defaultRoleDesc"     => "ヒント：システムにはデフォルトで組み込みの権限があり、権限の変更はサポートされていません。新しい権限を作成できます",
    ...
    "admin.role.userAuth"            => "ユーザー権限の設定（ユーザー権限、部署権限）",    
    "admin.role.userFav"             => "お気に入り操作",
    "admin.role.itemEdit"            => "追加/変更/削除",
    "admin.role.groupEdit"           => "部署の編集（追加/変更/削除）",    
    "admin.role.delErrTips"          => "ロールは使用中のため削除できません！",    
    "admin.authFrom.setUser"         => "ユーザー権限の指定",
    "admin.authFrom.setGroup"        => "部署の権限を指定する",    
    "admin.authFrom.setAll"          => "その他のユーザー権限",
    "admin.authFrom.groupAt"         => "部署当局",    
    "admin.authFrom.groupParent"     => "上位部署の権限",    
    "admin.authFrom.pathOnly"        => "アクセスのみ、下位レベルにはコンテンツと権限があります",
    "admin.authFrom.groupRoot"       => "部署のルートディレクトリ",    
    "admin.auth.owner"               => "所有者",
    "admin.auth.editor"              => "編集者",
    "admin.auth.editUploader"        => "編集/アップロード者",
    "admin.auth.viewer"              => "閲覧者",
    "admin.auth.previewer"           => "プレビュー閲覧者",
    "admin.auth.uploader"            => "アップロード者",
    "admin.auth.invisible"           => "閲覧不可",
    ...
    "admin.auth.error"               => "権限エラー（権限設定なし）",
    "admin.auth.errorAdmin"          => "権限が不十分",
    "admin.auth.targetError"         => "権限オブジェクトの種類が間違っています。ユーザーまたは部署である必要があります",    
    "admin.auth.errorAuthToGroup"    => "非ルート部署、部署への委任はサポートしていません",    
    "admin.auth.errorAuthToUsers"    => "非ルートセクター、セクター外のメンバーへの委任はサポートしていません",
    "admin.auth.displayDesc"         => "部署のユーザー権限を設定するときに表示するかどうか",    
    "admin.auth.defaultAuthDesc"     => "ヒント：システムにはデフォルトで組み込みの権限グループがあり、権限の変更はサポートしていません。新しい権限グループを作成できます",
    ...
    "admin.auth.event"               => "ドキュメントのアクティビティ",
    "admin.auth.eventAction"         => "ドキュメントの動的表示、サブスクリプションの動的",
    "admin.auth.root"                => "管理権",
    "admin.auth.rootAction"          => "メンバー権限の設定/コメント管理/バージョン履歴管理",
    ...
    "admin.plugin.typeFile"          => "ファイル機能拡張",
    "admin.plugin.typeSafe"          => "セキュリティツール",
    "admin.plugin.typeTools"         => "ユーティリティ",
    "admin.plugin.typeMedia"         => "マルチメディア",
    "admin.plugin.typeCompany"       => "エンタープライズアプリケーション",
    "admin.plugin.typeBuy"           => "有料アプリ",
    "admin.plugin.typeOem"           => "カスタム",
    "admin.plugin.needNetwork"       => "外部ネットワーク接続が必要",
    ...
    "admin.plugin.downloadNumber"    => "インストール回数",
    "admin.plugin.back"              => "戻る",
...
<li>更新：ダウンロード後、対応するプラグイン名フォルダーにアップロードして解凍します。</li>",
    ...
    "admin.storage.ifDel"            => "現在のストレージを削除してもよろしいですか？",
    ...
    "admin.storage.ifRmBakNow"       => "このストレージにはバックアップデータが含まれています。これを直接削除してもよろしいでしょうか？",
    "admin.storage.moveErr"          => "ストレージに接続できず、データ移行を完了できません。",
    "admin.storage.ifRmErrNow"       => "ストレージに接続できず、データ移行も完了できません。直接削除すべきでしょうか？",
    ...
    "admin.storage.sizeTips"         => "容量サイズは0より大きくなければなりません",    
    ...
    "admin.storage.ossDomain"        => "OSSスペースに連携されたドメイン名",
    ...
    "admin.storage.qiniuDomain"      => "Qiniu Spaceによって連携されたドメイン名",
    ...
    "admin.storage.awsDomain"        => "AWSスペースで連携されたドメイン名",
    ...
    "admin.storage.spaceUsed"        => "実際の使用量",
    "admin.storage.spaceLave"        => "残容量",
    ...
    "admin.storage.ussDomain"        => "クラウドスペースに連携されたドメイン名の別のショットを撮ります",
    "admin.storage.ussToken"         => "秘密トークン",
    "admin.storage.ussTokenDesc"     => "トークンホットリンク防止秘密鍵（必須ではありません）",
    ...
    "admin.install.defRoleError"     => "デフォルトの権限の追加に失敗しました",
    "admin.install.defGroupError"    => "システム部署の追加に失敗しました",    
    ...
    "admin.install.groupFile"        => "部署文書",    
    "admin.install.userFile"         => "ユーザードキュメント",
    "admin.install.role"             => "権限",
    "admin.install.fileAuth"         => "ドキュメントのアクセス権限",
    ...
    "admin.log.thirdBind"            => "サードパーティのアカウントを連携する",
    "admin.log.delBind"              => "連携解除",
    ...
    "admin.log.addUserTo"            => "ユーザーを部署に追加する",    
    "admin.log.removeUserFrom"       => "ユーザーが部署から削除されました",    
    "admin.log.switchUserGroup"      => "ユーザー移行部署",    
    "admin.log.stausUser"            => "ユーザーを有効/無効にする",
    "admin.log.addRole"              => "新しい権限",
    "admin.log.editRole"             => "権限を編集",
    "admin.log.delRole"              => "権限を削除",
    "admin.log.addAuth"              => "権限を追加する",
    "admin.log.editAuth"             => "権限を編集",
    "admin.log.delAuth"              => "削除権限",
    "admin.log.editShare"            => "共有を編集",
    "admin.log.delLinkTo"            => "外部リンクの共有をキャンセル",
    "admin.log.delShareTo"           => "コラボレーションをキャンセルする",
    ...
    "admin.backup.checkLog"          => "詳細については、ログを参照してください。<br/>データ/temp/log/バックアップ/current_date__log.php",
    ...
    "admin.backup.notFinished"       => "未完了",
    "admin.backup.timeTaken"         => "処理時間",
    "admin.backup.node"              => "ノード",
    "admin.backup.notYet"            => "データがありません",
    ...
    "admin.backup.optionFileTimeDesc" => "ファイルバックアップタスクは1分ごとに実行されます。業務時間外に実行することをお勧めします。",
    ...
    "admin.share.targetTitle"        => "コラボレーションのための部署またはユーザー",    
    ...
    "admin.share.reportTab"          => "レポート管理",
    "admin.share.rptType1"           => "著作権侵害",
    "admin.share.rptType2"           => "わいせつ",
    "admin.share.rptType3"           => "残虐な暴力",
    "admin.share.rptType4"           => "政治的有害",
 ...
 post_max_size、再起動が必要）",
    ...
    "admin.setting.downloadZipClientDesc" => "外部ネットワークに接続できるか、サイトが HTTPS である必要があります。",
    ...
    "admin.setting.fileHistoryMaxDesc" => "200 を推奨します。0 の場合はファイルバージョン履歴が閉じられ、500 を超える場合は制限がありません。",
    "common.----"                    => "----",
    "common.width"                   => "横幅",
    "common.height"                  => "高さ",
    "common.test"                    => "テスト",
    ...
    "common.less"                    => "より小さい",
    "common.print"                   => "印刷する",
    "common.selectInvert"            => "選択解除",
    "common.selectAll"               => "すべて選択/解除",
    ...
    "common.bindSuccess"             => "連携に成功しました！",
    "common.bindError"               => "連携に失敗しました",
    "common.clear"                   => "空の",
    "common.congrats"                => "おめでとう、",
    "common.sorry"                   => "申し訳ありません",
    "common.invalid"                 => "無効です",
    ...
    "common.maintenanceTips"         => "システムメンテナンス中です。後ほどご確認ください",
    "common.ready"                   => "保留中",
    "common.done"                    => "完了",
    "common.disabled"                => "無効",
    "common.sizeTotal"               => "合計サイズ",
    "common.sqlStatement"            => "[SQLステートメント]：",
    "common.env.check"               => "環境試験",
    "common.env.errorLib"            => "PHPライブラリがありません",
    "common.env.errorIgnore"         => "無視して入力",
    "common.env.errorVersion"        => "PHPバージョンは5.3以上である必要があります",
    ...
    "common.env.installWithBtTips"   => "サーバーの PHP バージョンは 5.3 以上が必須です。推奨されている<a target='_blank' href='http://www.bt.cn/?ref=https://kodcloud.com'>pagodaパネルの</a>ワンクリック設定については詳しくありません。 <br/>現在のバージョン",
    ...
    "common.env.pathPermissionError" => "[エラーコード：1002]ディレクトリ権限エラー！プログラムディレクトリとすべてのサブディレクトリを読み取りおよび書き込みに設定してください。 <br/> linuxは次のコマンドを実行します。 <pre> su -c 'setenforce 0' <br/> chmod -R 777",
    "common.version.free"            => "無料",
    "common.version.nameQ"           => "エンタープライズ版",
    "common.version.vipFree"         => "無料版",
    "common.version.useFree"         => "無料版の使用を続ける",
    "common.version.notSupport"      => "お使いのバージョンはこの操作をサポートしていません。公式ウェブサイトにアクセスして、上位のバージョンを購入してください",
    ...
    "common.copyright.formLogoImageDesc" => "ログインページと管理背景ロゴ、推奨サイズ250x100、透過png形式",
    "common.copyright.formLogoMain"  => "メインインターフェイスメニューのロゴ",
    "common.copyright.formLogoMainDesc" => "ファイル管理の左上隅のロゴ、推奨サイズ200x200、白い透過png形式",
    "common.copyright.formPowerByInfo" => "会社著作権情報設定",
    "common.copyright.formPowerBy"   => "下部の著作権会社名",
    "common.copyright.formHomePage"  => "下部の著作権リンク",
    "common.copyright.formConcat"    => "連絡先ポップアップ",
    ...
    "common.copyright.agreeOpen"     => "有効・無効",
    "common.copyright.agreeDesc"     => "有効にすると、同意リンクがログイン ページに表示され、ユーザーはログインする前に同意をする必要があります。",
    ...
    "common.charset.BIG5_HKSCS"      => "繁体字-香港",
    "common.charset.BIG5"            => "伝統的な台湾",
    "common.charset.Georgian_Academy" => "グルジア語",
    "common.charset.PT154"           => "カザフ語",
    "common.charset.CP949"           => "韓国語",
    ...
    "common.charset.ARMSCII_8"       => "アルメニア語",
    "common.charset.CP1258"          => "ベトナム語",
    ...
    "explorer.lockError"             => "エラーが発生し、同時実行ロックがタイムアウトしました",
    ...
    "explorer.sessionSaveError"      => "セッションの書き込みに失敗しました。ディスクの空き容量を確認いただくか、ご契約のサービスプロバイダーにご相談ください。",
    ...
    "explorer.recycleClear"          => "ごみ箱を空にする",
    ...
    "explorer.zipClientLimit1"       => "ファイルサイズが4GBを超える場合、フロントエンド圧縮が完了できません。一括ダウンロードまたはクライアントのご利用をお選びください。",
    "explorer.zipClientLimit2"       => "4GB を超えるファイルはフロントエンドで圧縮できません。",
    ...
    "explorer.unziping"              => "解凍中...",
    "explorer.zipingTips"            => "圧縮中です。しばらくお待ちください...",
    "explorer.unzipingTips"          => "解凍中です。しばらくお待ちください...",
    ...
    "explorer.search.optionGroup"    => "サブ部署を検索",    
    "explorer.search.optionGroupDesc" => "自分が所有者の場合、部署のルート ディレクトリを検索するときに、サブ部署のコンテンツも同時に検索します。",    
    "explorer.search.optionGroupTips" => "およびサブ部署",    
    "explorer.removeSuccess"         => "削除しました！",
    "explorer.removeFail"            => "削除に失敗しました！",
    "explorer.clipboardNull"         => "クリップボードが空です！",
    "explorer.createSuccess"         => "新規に作成しました。",
    ...
    "explorer.noPermissionExt"       => "管理者がこのタイプのファイル権限を無効にしました",
    ...
    "explorer.theChars"              => "文字",
    "explorer.theItems"              => "アイテム",
    "explorer.noData"                => "データなし",
    "explorer.ifPathAuthClear"       => "すべてのサブファイルとフォルダーのアクセス権限設定がクリアされます。続行してもよろしいですか？",
    ...
    "explorer.editor.fileTooBig"     => "ファイルが大きすぎます。20Mを超えることはできません。",
    ...
    "explorer.delFav"                => "お気に入りから削除",
    "explorer.addFavSuccess"         => "お気に入りを追加しました",
    "explorer.pathHasFaved"          => "パスはお気に入りに追加済です。",
    "explorer.delFavSuccess"         => "削除しました。",
    ...
    "explorer.openAutoTips"          => "自動的に開く",
    "explorer.historyAutoTips"       => "バージョン履歴を自動生成",
    "explorer.saved"                 => "正常に保存されました",
    "explorer.opened"                => "正常に開きました。",
    ...
    "explorer.unzipErrorTips"        => "エラーが発生しました！認識されない圧縮ファイル形式。 <br/>ファイルが圧縮されているか、破損していないか確認してください。",
    "explorer.wordLoading"           => "読み込み中...",
    "explorer.noFunction"            => "該当メソッドがありません。",
    ...
    "explorer.appSelectMenuCancel"   => "デフォルトのオープンモードを解除",
    ...
    "explorer.authNote"              => "注：管理機能には、メンバー権限の設定/コメント管理などが含まれます。注意してください！ [システム管理者]は権限によって制限されません",
    "explorer.auth.toOuter"          => "外部認証（他の部署またはユーザー）",    
    ...
    "explorer.toolbar.myShare"       => "マイシェア",
    "explorer.toolbar.shareToMe"     => "共同作業",
    "explorer.toolbar.shareTo"       => "マイコラボ",
    "explorer.toolbar.shareLink"     => "外部リンク共有",
    "explorer.toolbar.photo"         => "マイフォト",
    ...
    "explorer.photo.fileSizeDesc"    => "この設定値より大きいファイルのみをフィルタリングします。0の場合、制限はありません。",
    ...
    "explorer.pathDesc.home"         => "マイスペースはあなたのプライベートストレージ容量です、
他のユーザーには表示されず、自分だけに表示されます",
    "explorer.pathDesc.groupRoot"    => "これは、企業/ユニットのパブリック容量です。
デフォルトでは、すべてのメンバーが表示されます",
    "explorer.pathDesc.myGroup"      => "ここであなたの部署のドキュメントを管理し、
部署のドキュメントは、この部署のメンバーのみが表示および操作でき、他の部署のメンバーには表示されません。",
    "explorer.pathDesc.group"        => "部署のメンバーにのみ表示される部署のネットワークディスクで、
運用権限は、部署管理者が割り当て、設定します。",
    ...
    "explorer.pathDesc.shareToMeGroup" => "私がコラボレーションしているコンテンツは、フォルダーが配置されている部署によって分類されています",    
    "explorer.pathDesc.shareToMeGroupGroup" => "部署のネットワークディスクからのコラボレーション",    
...
拼音、最初の文字のあいまい一致をサポート",
    ...
    "explorer.pathGroup.shareGroup"  => "部署スペース",    
    "explorer.pathGroup.shareGroupDesc" => "下位部署にコンテンツがある場合のアクセス",    
    "explorer.pathGroup.shareUser"   => "部署メンバーの個人的なスペース共有",    
    "explorer.pathGroup.shareUserDesc" => "出典：ユーザーの個人用スペースの共有、ユーザーが開始した外部部署のドキュメント共有。",    
    "explorer.pathGroup.shareContent" => "部署のスペースコラボレーションと共有",    
    "explorer.pathGroup.group"       => "サブ部署",    
    "explorer.pathGroup.groupContent" => "部署文書",    
    "explorer.pathGroup.shareUserOuter" => "外部コラボレーション共有",
    "explorer.pathGroup.shareUserOuterDesc" => "独自の組織構造に属さない外部ユーザーのコラボレーション",
    "explorer.pathGroup.shareSelf"   => "マイスペース",
    "explorer.toolbar.fileSizeTitle" => "アイコンサイズ",
    "explorer.toolbar.fileSizeSuper" => "最小",
    "explorer.toolbar.fileSizeSmall" => "小アイコン",
    "explorer.toolbar.fileSizeDefault" => "中アイコン",
    "explorer.toolbar.fileSizeBig"   => "大アイコン",
    "explorer.toolbar.fileSizeBigSuper" => "特大アイコン",
    ...
    "explorer.app.groupReader"       => "リーダー",
    "explorer.app.groupMovie"        => "ビデオ",
    ...
    "explorer.app.openType"          => "アクセス方式",
    "explorer.app.openWindow"        => "新しいウィンドウ",
    ...
    "explorer.upload.secPassSuccess" => "高速アップロード成功",
    ...
    "explorer.search.resultTooMore"  => "検索結果が多すぎるため、別のディレクトリまたは単語で検索してください",
    ...
    "explorer.search.noResult"       => "申し訳ありませんが、検索結果はありません。別の検索ワードを試してください。",
    "explorer.search.advance"        => "高度な検索",
    "explorer.search.clear"          => "明確なコンテンツ",
    "explorer.search.optionDesc"     => "ファイルの説明",
    "explorer.search.optionTag"      => "ユーザー/部署ラベル",    
    ...
    "explorer.history.diff"          => "過去のバージョンと比較",
    ...
    "explorer.history.changeEvent"   => "過去のバージョンと切り替え",
    "explorer.history.action"        => "旧バージョンの操作",
    "explorer.history.remove"        => "バージョン履歴を削除する",
    ...
    "explorer.recycle.moveTo"        => "ハンドオーバー",
    ...
    "explorer.recycle.configOpenInfo" => "<li>個人文書または部署文書は、ごみ箱を完全に削除または空にした後、システムのごみ箱に入ります。</li><li>削除されたコンテンツは、ファイルが配置されているユーザーまたは部署に応じてユーザーまたは部署フォルダーに分類され、管理者はこれらのファイルを復元することを選択できます。</li><li>自動完全削除の前のファイルは、定期的に自動的に空になります。</li><li>注：ここで削除されたファイルは復元できません。</li>",    
    ...
    "explorer.recycle.moveSelectTarget" => "ユーザーまたは部署を選択します",    
    "explorer.recycle.moveDesc"      => "<li>指定されたユーザーまたは部署に引き渡します。オブジェクトのルートディレクトリに移行されます</li><li>引き渡し後、ドキュメントの説明、交換、ディスカッション、バージョン履歴、その他の情報は引き続き保持されます。共有されているコラボレーションと権限の情報は削除されます。</li>",    
    "explorer.recycle.taskTitle"     => "システムのごみ箱の清掃",
    "explorer.recycle.taskDesc"      => "設定時間を超えたごみ箱の内容を自動的に削除して、ストレージ容量を解放します",    
    ...
    "explorer.share.errorTime"       => "この共有は期限切れです！",
    ...
    "explorer.share.shareTo"         => "コラボレーション",
    ...
    "explorer.share.shareSystemDesc" => "他のアプリやプラグインによって作成されたコラボレーション",
    "explorer.share.selectTarget"    => "コラボレーションする部署またはユーザーを選択します",    
    "explorer.share.afterShareDesc"  => "相手または所属する部署と共有すると、ユーザーは[共有]でそれを見ることができます。",    
    ...
    "explorer.share.authLimit"       => "権限と制限",    
    ...
    "explorer.share.downNumLimitDesc" => "この回数を超えると、共有リンクは自動的に期限切れになります。",
    "explorer.share.learnAuth"       => "ドキュメントコラボレーション権限について",
    "explorer.share.shareToRemove"   => "このコラボレーションをキャンセルしてもよろしいですか？<br/>共有したターゲットユーザーは、コラボレーションを表示できなくなります。",
    "explorer.share.shareLinkRemove" => "外部リンクの共有をキャンセルしてもよろしいですか？<br/>キャンセル後、外部リンクは無効になります！",
    "explorer.share.shareToCopy"     => "アクセスパスをコピーする",
    "explorer.share.shareToCopyDesc" => "リンクをコラボレーションメンバーに送信して、すぐに共同作業に参加できます",
    "explorer.share.specifyAuthTips" => "上記の指定ユーザーに加えて",
    "explorer.share.specifyAuthDesc" => "指定ユーザー権限>指定ユーザーの部署権限>その他の個人権限",    
    "explorer.share.selfAuthDesc"    => "自分の権限を変更することはできません。他のマネージャーが設定できます",
    "explorer.share.authTypeDesc"    => "既定で親フォルダーからアクセス権限を継承する",
    "explorer.share.rootPathAuthDesc" => "ルート部署のサポートユーザーおよび部署の選択",    
    "explorer.share.subPathAuthDesc" => "サブ部署、部署のメンバーのみを選択",    
    "explorer.share.myAuth"          => "マイ権限",
    "explorer.share.othersAuth"      => "その他の権限",
    "explorer.share.keepAuth"        => "元の権限を保持",
    "explorer.share.specifyAuth"     => "権限を指定する",
    "explorer.share.userAuth"        => "ユーザー権限",
    "explorer.share.specifyUserAuth" => "ユーザー権限の指定",
    ...
    "explorer.shareOut.title"        => "外部コラボレーション",
    "explorer.shareOut.desc"         => "異なるネットワークディスクサイト間でコンテンツを共有する",
    "explorer.shareOut.titlePath"    => "外部コラボレーション",
    ...
    "explorer.shareOut.sendDesc2"    => "ネットワーク ディスクのメイン プログラム バージョンが一致している必要があり、他のサイトで外部コラボレーション機能が有効になっている必要があります。",
    ...
    "explorer.shareOut.targetUserDesc3" => "サポート部署IDの指定（例）",    
    ...
    "explorer.shareOut.siteSafeDesc1" => "外部コラボレーションに使用する場合、信頼できるサイトの組織構造を取得し、ユーザーと部署を素早く選択できます。",    
    "explorer.shareOut.siteSafeDesc2" => "ネットワーク ディスク プログラムのバージョンが一致している必要があり、他のサイトで外部コラボレーションおよび受信機能が有効になっている必要があります。",
    ...
    "explorer.shareOut.siteApiKeySelfDesc1" => "このAPIKeyはコラボレーションクラウド共有と信頼できるサイトへのアクセスにのみ使用されます",
    ...
    "explorer.shareOut.errorDisableSend" => "外部リンク共有・外部コラボレーション機能が有効になっていません！",
    "explorer.shareOut.errorDisableReceive" => "外部リンク共有・外部コラボレーション機能が有効になっていません！",
    ...
    "explorer.auth.mutilDesc"        => "後続のデフォルトのアクセス権限と同時に",
    "explorer.auth.showMore"         => "権限の詳細",
    "explorer.auth.tabUser"          => "部署メンバー",    
    "explorer.auth.tabChildren"      => "サブフォルダーのアクセス権限",
    "explorer.auth.tabParentTips"    => "このフォルダに対する権限を持つユーザーまたは部署（上位レベルの権限すべてから継承）",    
    "explorer.auth.tabUserTips"      => "部署メンバーの初期権限",    
    ...
    "explorer.auth.resetUserBtnTips" => "このフォルダー内のユーザーとすべてのサブフォルダー（フォルダー）のアクセス権限を上書きします",
    "explorer.auth.resetUserHeader"  => "下位フォルダーには、ユーザーのアクセス権限を指定するコンテンツが含まれており、すべてのオーバーライドを上記のアクセス権限に設定します",
    "explorer.auth.resetUserContiner" => "ユーザーの権限の内容が含まれています",
    "explorer.auth.resetUserEmpty1"  => "このユーザーに権限が設定されているコンテンツはありません。オーバーライドする必要はありません。",
    "explorer.auth.resetUserEmpty2"  => "すべての子コンテンツは、現在のレベルのフォルダーのアクセス権限を継承します",
    ...
    "explorer.editor.charAllDisplay" => "不可視文字を表示",
    ...
    "explorer.sync.listClearDone"    => "消去完了",
    ...
    "explorer.groupTag.title"        => "パブリックラベル",    
    "explorer.groupTag.menuTtitle"   => "部署のパブリックラベル",    
    "explorer.groupTag.titleDesc"    => "部署内のパブリックラベル",    
    "explorer.groupTag.empty"        => "部署管理者がパブリックラベルを設定すると、自動的に有効になります。ラベルの内容がない場合、パブリックラベルは自動的にオフになります。",    
    "explorer.tag.pathDesc"          => "個人ラベルでフィルタリング",
    "explorer.groupTag.pathDesc"     => "部署のパブリックラベルでフィルタリング",    
    ...
    "explorer.groupTag.addDesc"      => "タグを追加すると、部署タグが自動的に有効になり、タグの最大数は1000になります",    
    "explorer.panel.info"            => "全般",
    "explorer.panel.version"         => "バージョン",
    "explorer.panel.chat"            => "チャット",
    "explorer.panel.log"             => "ログ",
    "explorer.panel.meta"            => "メタデータ",
    "explorer.panel.chatName"        => "ディスカッション",
    "explorer.panel.chat.send"       => "送信",
    ...
    "explorer.safe.name"             => "機密フォルダ",
    "explorer.safe.desc"             => "機密フォルダは大切なデータを二重に保護します。",
    "explorer.safe.userShow"         => "マイスペースのルートディレクトリの表示",
    "explorer.safe.adminOpen"        => "マイスペースの機密フォルダを有効にする",
    "explorer.safe.adminOpenDesc"    => "閉じると、無効になっていたものは有効にできなくなり、有効になったものは影響を受けません。",
    "explorer.safe.isNotOpen"        => "機密フォルダが開かれていない",
    "explorer.safe.isNotLogin"       => "機密フォルダにログインしていない",
    "explorer.safe.isLogin"          => "機密フォルダにサインインしました",
    "explorer.safe.open"             => "プライベートセーフを有効にする",
    "explorer.safe.doOpen"           => "今すぐアクティブ化する",
    "explorer.safe.doOpenTips"       => "電子メール アドレスが連携されていません。パーソナル センターで電子メール アドレスを連携して、もう一度お試しください (パスワード取得のため)",
    "explorer.safe.doOpenSuccess"    => "機密フォルダが正常に作動しました。",
    "explorer.safe.doOpenOpend"      => "オン",
    "explorer.safe.doLoginOk"        => "機密フォルダに入りました！",
    "explorer.safe.doCheckLimit"     => "1分に1回のみ送信可能",
    "explorer.safe.sendMailTitle"    => "機密フォルダパスワードの取得",
    ...
    "explorer.secret.isOpen"         => "有効・無効",
    "explorer.secret.isOpenDesc"     => "セキュリティ レベル管理の有効化と無効化",
    "explorer.secret.setUser"        => "シークレットマネージャー",
    "explorer.secret.setUserDesc"    => "機密レベルを設定できるユーザーを指定します（該当部署のオーナーにすることを推奨します）",    
    ...
    "explorer.secret.auth"           => "秘密レベルの権限",
    "explorer.secret.authHas"        => "機密権限には以下が含まれます",
    "explorer.secret.createUser"     => "セッター",
    "explorer.secret.folderAt"       => "親展フォルダ",
    "explorer.secret.tips"           => "アクセス権限はシークレット レベルによって制御され、シークレット レベルのアクセス権限はドキュメントのアクセス権限よりも高くなります。",
    "explorer.secret.tips1"          => "部署ネットワークディスク内のコンテンツのみ、上記の指定ユーザー（フォルダ所有者であることが推奨されます）が設定できます。",    
    "explorer.secret.tips2"          => "機密レベルを持つフォルダの下層のすべてのコンテンツが設定され、この権限は最高の権限です",
    "explorer.secret.tips3"          => "設定後、セキュリティレベルの権限は文書の権限よりも高くなります（文書の所有者もセキュリティレベルの権限の対象となりますが、システム管理者はこの制限の対象外であり、セキュリティレベルを設定した人もこの制限の対象外です）。",
    "explorer.secret.tips4"          => "機密レベルの権限: \"部署およびメンバー管理 - ドキュメント著作権管理\"で追加でき、非表示に設定できます",    
    "user.----"                      => "----",
    ...
    "user.recycleDesc"               => "削除ファイルはごみ箱に移動します。",
    ...
    "user.bindAccount"               => "アカウントを連携",
    "user.thirdBindFirst"            => "アカウントは連携されていません。連携後に使用してください",
    "user.account"                   => "アカウント",
    "user.bind"                      => "連携",
    "user.unbind"                    => "連携解除",
    "user.binded"                    => "連携済み",
    "user.clickBind"                 => "連携をクリック",
    "user.clickToBind"               => "連携をクリック",
    ...
    "user.bindOthers"                => "別のアカウントに既に連携されています",
    "user.notBind"                   => "まだ連携されていません",
    "user.regist"                    => "ユーザー登録",
    "user.notRegist"                 => "未登録",
    "user.registed"                  => "登録済み",
    ...
    "user.unbindWarning"             => "連携を解除する前にパスワードを変更してください。変更しないと、アカウントは正しく機能しません。",
    "user.isLoginTips"               => "現在ログインしていることが検出されました！",
    "user.isLoginEnter"              => "今すぐ入る",
    "user.ifUnbind"                  => "連携を解除してもよろしいですか？",
    "user.bindFirst"                 => "最初にメールまたは携帯電話番号を連携してください",
    ...
    "user.userEnabled"               => "アカウントが無効化されたか、まだ有効になっていません！管理者に連絡してください。",
    "user.roleError"                 => "権限グループが存在しません。管理者に連絡してください",
    ...
    "user.registNotAllow"            => "システムは登録を実行できません。管理者に連絡してください。",
    ...
    "user.wall.paperLoginTips"       => "複数の画像がある場合、ログインインターフェイスの背景がランダムに変わります。",
    ...
    "log-type-share-shareToAdd"      => "コラボレーションがオンになっています",
    "log-type-share-shareLinkRemove" => "閉じたリンクの共有",
    "log-type-share-shareToRemove"   => "コラボレーションをオフにする",
    ...
    "log-event-share-shareToAdd"     => "このドキュメントのコラボレーションを有効にする",
    "log-event-share-shareToAdd-item" => "[1]コラボレーションを有効にしました",
    "log-event-share-shareToAdd-more" => "[1]コラボレーションシェアが作成されました",
    ...
    "log-event-share-shareToRemove"  => "このドキュメントのコラボレーションをオフにする",
    "log-event-share-shareToRemove-item" => "[1]のコラボレーション共有をオフにする",
    "log-event-share-shareToRemove-more" => "閉じる[1]コラボレーション",
    ...
    "explorer.fileInfo.imageDpi"     => "解像度",
    ...
    "explorer.fileInfo.cameraExposureTime" => "露光時間",
    ...
    "explorer.fileInfo.audioChannel1" => "モノラル",
    ...
    "explorer.fileInfo.audioTitle"   => "タイトル",
