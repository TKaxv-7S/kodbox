...
<li> نطاق IP: تطابق IP ضمن النطاق ؛ على سبيل المثال: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.uploadDataInvalid" => "انتهت صلاحية البيانات التي تم تحميلها. يرجى إعادة إرسالها!",
    ...
    "admin.member.importDisable"     => "تعطيل (تعطيل -1، تمكين -0، أو فارغ)",
    "admin.member.importSizeLimit"   => "حجم الملف يتجاوز الحد المسموح به ([1]).",
    "admin.member.importDownErr"     => "فشل تنزيل الملف!",
    "admin.member.importEmpty"       => "الملف فارغ!",
    "admin.member.importAllErr"      => "لم يتم العثور على معلومات حساب صالحة. يرجى التحقق!",
    "admin.member.importPartErr"     => "بعض معلومات الحساب غير صحيحة. يرجى التحقق!",
    "admin.member.importStart"       => "تم التحقق من اكتمال العملية، ابدأ الاستيراد.",
    "admin.member.importGroupErr"    => "القسم فارغ.",
    "admin.member.importNameErr"     => "الحساب فارغ",
    "admin.member.importPwdErr"      => "كلمة المرور فارغة.",
    "admin.member.importGroupAuthErr" => "تصاريح القسم فارغة.",
    "admin.member.importSysErr"      => "خطأ في النظام",
    "admin.member.importGroupAuthCntErr" => "لا تتطابق الإدارة والسلطة",
    "admin.member.importGroupPathErr" => "مسار القسم المحدد غير موجود.",
    "admin.member.importAuthErr"     => "الإذن المحدد غير موجود:",
    "admin.member.importGroup1"      => "تخزين سحابي للمؤسسات / قسم البحث والتطوير / مجموعة البحث والتطوير 2",
    "admin.member.importGroup2"      => "قسم التخزين السحابي للمؤسسات/ قسم العمليات والصيانة",
    "admin.member.importCopyGroupTips" => "يتم تحميل بيانات القسم، يرجى المحاولة مرة أخرى لاحقاً.",
    "admin.member.importCopyTips"    => "فشلت عملية النسخ، يرجى تحديث الصفحة والمحاولة مرة أخرى!",
    "admin.member.importCheckStart"  => "بدء الفحص",
    "admin.member.importCheckRest"   => "نتائج الفحص",
    "admin.member.importSaveRest"    => "نتائج الاستيراد",
    "admin.member.importLineNum"     => "رقم السطر",
    "admin.member.importContinue"    => "استمر في الاستيراد",
    "admin.member.importIDNumber"    => "بطاقة الهوية",
    "admin.member.importUserSize"    => "حجم مساحة المستخدم",
    "admin.member.importUserSizeDesc" => "الصفر يمثل عدم وجود قيود",
    "admin.member.importUserRole"    => "أدوار المستخدمين وصلاحياتهم",
    "admin.member.importUserGroup"   => "قسم المستخدم",
    "admin.member.importGroupSet"    => "الإعدادات الموحدة",
    "admin.member.importGroupImport" => "استيراد الإعدادات",
    "admin.member.importGroupDesc"   => "إعدادات موحدة: حدد الإعدادات في الواجهة لتحديد قسم وصلاحيات موحدة لجميع الحسابات المستوردة [0]. إعدادات الاستيراد: أضف حقلي القسم والصلاحيات إلى القالب. يُملأ حقل القسم بالمسار الكامل للقسم (مثل:<code>企业网盘/研发部/研发二组</code>)، وتُفصل الحقول المتعددة بفاصلة منقوطة <code>;</code> ). يُملأ حقل الصلاحيات باسم الصلاحية، وتُفصل الحقول المتعددة أيضًا بفاصلة منقوطة <code>;</code> . يتطابق محتوى الحقلين تمامًا.",
    "admin.member.importCopyTool"    => "أداة النسخ",
    "admin.member.importCopyToolDesc" => "انقر فوق الزر لفتح نافذة النسخ، حيث يمكنك نسخ مسارات الأقسام والأذونات المطلوبة لملء النموذج.",
    "admin.member.importCopyGroup"   => "مسار النسخ",
    "admin.member.importCopyGroupDesc" => "انسخ المسار الكامل للقسم المحدد",
    "admin.member.importCopyAuth"    => "إذن النسخ",
    "admin.member.importCopyAuthDesc" => "اسم إذن النسخ",
    "admin.member.importMetaMore"    => "الحقول الموسعة",
    "admin.member.importMetaMoreDesc" => "أضف المزيد من الحقول المخصصة إلى الملف المستورد",
    "admin.member.importMetaField"   => "الحقول المخصصة",
    "admin.member.importMetaFieldDesc" => "رقم الهاتف المحمول وعنوان البريد الإلكتروني هما حقلان نظاميان ويستخدمان فقط للفرز لتحديد أولوية مطابقة الهوية.",
    "admin.member.importFieldName"   => "اسم الحقل",
    "admin.member.importFieldDisable" => "انقر لتعطيل",
    "admin.member.importFieldEnable" => "انقر للتفعيل",
    "admin.member.importBindField"   => "مطابقة الهوية",
    "admin.member.importBindFieldDesc1" => "يقوم الاستعلام بمطابقة البيانات بناءً على الحقول المحددة بالترتيب؛ إذا تم العثور على حساب موجود، يتم تحديثه؛ وإلا، يتم إنشاء حساب جديد.",
    "admin.member.importBindFieldDesc2" => "لن يتم تحديث اسم المستخدم وكلمة المرور أثناء التحديث، ولكن لا يزال يتعين ملء حقل كلمة المرور.",
    "admin.member.importType"        => "طريقة الاستيراد",
    "admin.member.importType0"       => "استيراد إضافي",
    "admin.member.importType1"       => "استيراد كامل",
    "admin.member.importTypeValue"   => "معالجة حساب غير صالحة",
    "admin.member.importTypeValueDesc" => "أثناء عملية الاستيراد الكاملة، قم بمعالجة الحسابات غير الموجودة في الملف المستورد حاليًا.",
    "admin.member.importChangeGroup" => "الانتقال إلى القسم",
    "admin.member.importFile"        => "استيراد الملفات",
    "admin.member.importFileDesc"    => "يرجى ملء ملف القالب وفقًا للتنسيق المطلوب وتحميله إلى الدليل المناسب؛ ملاحظة: قد يتغير تنسيق القالب بناءً على الإعدادات.",
    "admin.member.selectCsv"         => "حدد ملف CSV المراد استيراده.",
    "admin.member.importDownData"    => "تصدير التيار",
    "admin.member.importDownDataDesc" => "قم بتصدير جميع الحسابات الجارية بتنسيق القالب.",
...
<li> تحديث: بعد التنزيل والتحميل وفك الضغط إلى مجلد اسم المكون الإضافي المقابل ؛</li>",
    ...
    "admin.storage.ifDel"            => "هل أنت متأكد من رغبتك في حذف وحدة التخزين الحالية؟",
    ...
    "admin.storage.ifRmBakNow"       => "تحتوي هذه الوحدة التخزينية على بيانات احتياطية. هل يجب حذفها مباشرةً؟",
    "admin.storage.moveErr"          => "لا يمكن توصيل وحدة التخزين ولا يمكن إكمال ترحيل البيانات.",
    "admin.storage.ifRmErrNow"       => "لا يمكن توصيل وحدة التخزين، ولا يمكن إكمال عملية نقل البيانات. هل يجب حذفها مباشرةً؟",
    ...
    "admin.storage.remove"           => "حذف التخزين",
    ...
    "admin.backup.checkLog"          => "للاطلاع على التفاصيل، يرجى مراجعة السجل:<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "يتم تشغيل مهمة النسخ الاحتياطي للملفات مرة واحدة في الدقيقة؛ ويوصى بتنفيذها خلال ساعات عدم العمل.",
 ...
 post_max_size ، تحتاج إلى إعادة التشغيل)",
    ...
    "admin.setting.downloadZipClientDesc" => "يجب أن يكون قادراً على الاتصال بالشبكة الخارجية، أو يجب أن يكون الموقع من نوع HTTPS.",
    ...
    "explorer.zipClientLimit1"       => "إذا كان حجم الملف أكبر من 4 جيجابايت، فلن يكتمل ضغط الواجهة الأمامية. يُرجى اختيار التنزيل على دفعات أو استخدام البرنامج.",
    "explorer.zipClientLimit2"       => "لا يمكن ضغط الملفات التي يزيد حجمها عن 4 جيجابايت في البداية.",
 ...
 دعم بينيين ، مطابقة غامضة للحرف الأول",
    ...
    "explorer.secret.tips3"          => "بعد التعيين، تكون أذونات مستوى الأمان أعلى من أذونات المستند (يخضع مالك المستند أيضًا لأذونات مستوى الأمان، لكن مسؤول النظام الفائق لا يخضع لهذا القيد، والشخص الذي قام بتعيين مستوى الأمان لا يخضع لهذا القيد).",
