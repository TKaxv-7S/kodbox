...
return array(
    ...
    "admin.setting.wallDiy"          => "사용자 배경화면 :",
...
<li> IP 범위 : ip는 범위 내에서 일치합니다 (예 : 192.168.1.1-192.168.200.255).</li>",
    ...
    "admin.member.uploadDataInvalid" => "업로드하신 데이터가 만료되었습니다. 다시 제출해 주세요!",
    ...
    "admin.member.importDisable"     => "비활성화(비활성화 -1, 활성화 -0 또는 비워둠)",
    "admin.member.importSizeLimit"   => "파일 크기가 제한을 초과합니다([1]).",
    "admin.member.importDownErr"     => "파일 다운로드에 실패했습니다!",
    "admin.member.importEmpty"       => "파일이 비어 있습니다!",
    "admin.member.importAllErr"      => "유효한 계정 정보가 없습니다. 확인해 주세요!",
    "admin.member.importPartErr"     => "일부 계정 정보가 잘못되었습니다. 확인해 주세요!",
    "admin.member.importStart"       => "확인이 완료되었습니다. 가져오기를 시작하세요.",
    "admin.member.importGroupErr"    => "해당 부서는 비어 있습니다.",
    "admin.member.importNameErr"     => "계정이 비어 있습니다",
    "admin.member.importPwdErr"      => "비밀번호가 비어 있습니다.",
    "admin.member.importGroupAuthErr" => "해당 부서의 권한 설정이 비어 있습니다.",
    "admin.member.importSysErr"      => "시스템 오류",
    "admin.member.importGroupAuthCntErr" => "부서와 담당 기관이 일치하지 않습니다.",
    "admin.member.importGroupPathErr" => "지정된 부서 경로가 존재하지 않습니다.",
    "admin.member.importAuthErr"     => "지정된 권한이 존재하지 않습니다.",
    "admin.member.importGroup1"      => "기업용 클라우드 스토리지 / 연구개발부 / 연구개발그룹 2",
    "admin.member.importGroup2"      => "기업 클라우드 스토리지/운영 및 유지보수 부서",
    "admin.member.importCopyGroupTips" => "부서 정보가 로드 중입니다. 잠시 후 다시 시도해 주세요.",
    "admin.member.importCopyTips"    => "복사에 실패했습니다. 페이지를 새로고침하고 다시 시도해 주세요!",
    "admin.member.importCheckStart"  => "점검 시작",
    "admin.member.importCheckRest"   => "검사 결과",
    "admin.member.importSaveRest"    => "가져오기 결과",
    "admin.member.importLineNum"     => "줄 번호",
    "admin.member.importContinue"    => "계속 가져오기",
    "admin.member.importIDNumber"    => "신분증",
    "admin.member.importUserSize"    => "사용자 공간 크기",
    "admin.member.importUserSizeDesc" => "0은 제한이 없음을 나타냅니다.",
    "admin.member.importUserRole"    => "사용자 역할 및 권한",
    "admin.member.importUserGroup"   => "사용자 부서",
    "admin.member.importGroupSet"    => "통합 설정",
    "admin.member.importGroupImport" => "가져오기 설정",
    "admin.member.importGroupDesc"   => "통합 설정: 인터페이스에서 설정을 선택하여 가져온 모든 계정에 대해 통합 부서 및 권한을 지정합니다.[0] 가져오기 설정: 템플릿에 부서 및 권한 필드를 추가합니다. 부서 필드에는 부서의 전체 경로(예:<code>企业网盘/研发部/研发二组</code>)를 입력하고, 여러 필드는 세미콜론 <code>;</code> 으로 구분합니다. 권한 필드에는 권한 이름을 입력하고, 여러 필드는 세미콜론 <code>;</code> 으로 구분합니다. 두 필드의 내용은 일대일로 대응합니다.",
    "admin.member.importCopyTool"    => "복사 도구",
    "admin.member.importCopyToolDesc" => "버튼을 클릭하여 복사 창을 열고, 필요한 부서 경로와 권한을 복사하여 템플릿을 채울 수 있습니다.",
    "admin.member.importCopyGroup"   => "복사 경로",
    "admin.member.importCopyGroupDesc" => "선택한 부서의 전체 경로를 복사하세요.",
    "admin.member.importCopyAuth"    => "복사 권한",
    "admin.member.importCopyAuthDesc" => "복사 권한 이름",
    "admin.member.importMetaMore"    => "확장 필드",
    "admin.member.importMetaMoreDesc" => "가져온 파일에 사용자 정의 필드를 더 추가하세요",
    "admin.member.importMetaField"   => "사용자 정의 필드",
    "admin.member.importMetaFieldDesc" => "휴대전화 번호와 이메일 주소는 시스템 필드이며, 신원 일치 우선순위를 결정하기 위한 정렬 용도로만 사용됩니다.",
    "admin.member.importFieldName"   => "필드 이름",
    "admin.member.importFieldDisable" => "클릭하여 비활성화하세요",
    "admin.member.importFieldEnable" => "클릭하여 활성화하세요",
    "admin.member.importBindField"   => "신원 일치",
    "admin.member.importBindFieldDesc1" => "이 쿼리는 지정된 필드를 기준으로 순서대로 데이터를 일치시킵니다. 기존 계정이 발견되면 해당 계정을 업데이트하고, 그렇지 않으면 새 계정을 생성합니다.",
    "admin.member.importBindFieldDesc2" => "업데이트 과정에서 로그인 사용자 이름과 비밀번호는 변경되지 않지만, 비밀번호 입력란은 여전히 입력해야 합니다.",
    "admin.member.importType"        => "가져오기 방법",
    "admin.member.importType0"       => "추가 수입",
    "admin.member.importType1"       => "전체 수입",
    "admin.member.importTypeValue"   => "잘못된 계정 처리",
    "admin.member.importTypeValueDesc" => "전체 가져오기 과정에서 현재 가져온 파일에 존재하지 않는 계정을 처리합니다.",
    "admin.member.importChangeGroup" => "부서로 이동",
    "admin.member.importFile"        => "파일을 가져옵니다.",
    "admin.member.importFileDesc"    => "제공된 템플릿 파일을 형식에 맞춰 작성하신 후 해당 디렉토리에 업로드해 주십시오. 참고: 템플릿 형식은 설정에 따라 변경될 수 있습니다.",
    "admin.member.selectCsv"         => "가져올 CSV 파일을 선택하세요.",
    "admin.member.importDownData"    => "현재 내보내기",
    "admin.member.importDownDataDesc" => "모든 현재 계좌를 템플릿 형식으로 내보내기",
...
<li> 업데이트 : 다운로드 후 해당 플러그인 이름 폴더에 업로드하고 압축을 풉니 다.</li>",
    ...
    "admin.storage.ifDel"            => "현재 저장된 데이터를 정말로 삭제하시겠습니까?",
    ...
    "admin.storage.ifRmBakNow"       => "이 저장소에는 백업 데이터가 있습니다. 바로 삭제해야 할까요?",
    "admin.storage.moveErr"          => "스토리지를 연결할 수 없고 데이터 마이그레이션을 완료할 수 없습니다.",
    "admin.storage.ifRmErrNow"       => "저장 장치에 연결할 수 없어 데이터 마이그레이션을 완료할 수 없습니다. 바로 삭제해야 할까요?",
    ...
    "admin.backup.checkLog"          => "자세한 내용은 로그를 참조하십시오.<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "파일 백업 작업은 1분마다 실행되므로 업무 시간 외에 수행하는 것이 좋습니다.",
 ...
 post_max_size, 다시 시작해야 함)",
    ...
    "admin.setting.downloadZipClientDesc" => "외부 네트워크에 연결할 수 있어야 하거나, 사이트가 HTTPS를 사용해야 합니다.",
    ...
    "explorer.zipClientLimit1"       => "파일 크기가 4GB를 초과하면 프런트엔드 압축이 완료되지 않습니다. 여러 번에 나누어 다운로드하거나 클라이언트 프로그램을 이용해 주십시오.",
    "explorer.zipClientLimit2"       => "4GB보다 큰 파일은 사전 압축이 불가능합니다.",
    ...
    "explorer.toolbar.uiLogout"      => "로그아웃",
