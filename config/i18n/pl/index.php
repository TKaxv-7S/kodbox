...
<li> Zakres adresów IP: ip pasuje do zakresu; na przykład: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.uploadDataInvalid" => "Przesłane dane straciły ważność. Prześlij je ponownie!",
    ...
    "admin.member.importFailDesc"    => "Sukces: [1], Porażka: [2]",
    ...
    "admin.member.importDisable"     => "Wyłącz (Wyłącz -1, Włącz -0 lub puste)",
    "admin.member.importSizeLimit"   => "Rozmiar pliku przekroczył limit ([1]).",
    "admin.member.importDownErr"     => "Pobieranie pliku nie powiodło się!",
    "admin.member.importEmpty"       => "Plik jest pusty!",
    "admin.member.importAllErr"      => "Nie znaleziono prawidłowych informacji o koncie. Sprawdź!",
    "admin.member.importPartErr"     => "Niektóre dane konta są nieprawidłowe. Proszę sprawdzić!",
    "admin.member.importStart"       => "Po zakończeniu sprawdzania można rozpocząć importowanie.",
    "admin.member.importGroupErr"    => "Dział jest pusty.",
    "admin.member.importNameErr"     => "Konto jest puste",
    "admin.member.importPwdErr"      => "Hasło jest puste.",
    "admin.member.importGroupAuthErr" => "Uprawnienia departamentu są puste.",
    "admin.member.importSysErr"      => "Błąd systemu",
    "admin.member.importGroupAuthCntErr" => "Dział i organ nie pasują do siebie",
    "admin.member.importGroupPathErr" => "Podana ścieżka działu nie istnieje.",
    "admin.member.importAuthErr"     => "Podane uprawnienie nie istnieje:",
    "admin.member.importGroup1"      => "Przechowywanie danych w chmurze dla przedsiębiorstw / Dział badawczo-rozwojowy / Grupa badawczo-rozwojowa 2",
    "admin.member.importGroup2"      => "Magazynowanie w chmurze dla przedsiębiorstw/Dział operacji i konserwacji",
    "admin.member.importCopyGroupTips" => "Trwa ładowanie danych działu. Spróbuj ponownie później.",
    "admin.member.importCopyTips"    => "Kopiowanie nie powiodło się. Odśwież stronę i spróbuj ponownie!",
    "admin.member.importCheckStart"  => "Rozpocznij inspekcję",
    "admin.member.importCheckRest"   => "Wyniki inspekcji",
    "admin.member.importSaveRest"    => "Importuj wyniki",
    "admin.member.importLineNum"     => "numer wiersza",
    "admin.member.importContinue"    => "Kontynuuj importowanie",
    "admin.member.importIDNumber"    => "Dowód osobisty",
    "admin.member.importUserSize"    => "Rozmiar przestrzeni użytkownika",
    "admin.member.importUserSizeDesc" => "0 oznacza brak ograniczeń",
    "admin.member.importUserRole"    => "Role i uprawnienia użytkowników",
    "admin.member.importUserGroup"   => "Dział użytkownika",
    "admin.member.importGroupSet"    => "Ustawienia ujednolicone",
    "admin.member.importGroupImport" => "Ustawienia importu",
    "admin.member.importGroupDesc"   => "Ustawienia ujednolicone: Wybierz ustawienia w interfejsie, aby określić ujednolicony dział i uprawnienia dla wszystkich importowanych kont [0] Ustawienia importu: Dodaj pola działu i uprawnień do szablonu. Pole działu jest wypełniane pełną ścieżką działu (np.<code>企业网盘/研发部/研发二组</code>), a pola są rozdzielone znakiem <code>;</code> . Pole uprawnień jest wypełniane nazwą uprawnienia, a pola są również rozdzielone znakiem <code>;</code> . Zawartość obu pól jest równoważna jeden do jednego.",
    "admin.member.importCopyTool"    => "Narzędzie do kopiowania",
    "admin.member.importCopyToolDesc" => "Kliknij przycisk, aby otworzyć okno kopiowania, w którym możesz skopiować wymagane ścieżki i uprawnienia działów, aby wypełnić szablon.",
    "admin.member.importCopyGroup"   => "Kopiuj ścieżkę",
    "admin.member.importCopyGroupDesc" => "Skopiuj pełną ścieżkę wybranego działu",
    "admin.member.importCopyAuth"    => "Uprawnienia do kopiowania",
    "admin.member.importCopyAuthDesc" => "Kopiuj nazwę uprawnienia",
    "admin.member.importMetaMore"    => "Pola rozszerzone",
    "admin.member.importMetaMoreDesc" => "Dodaj więcej pól niestandardowych do importowanego pliku",
    "admin.member.importMetaField"   => "Pola niestandardowe",
    "admin.member.importMetaFieldDesc" => "Numer telefonu komórkowego i adres e-mail to pola systemowe, używane wyłącznie do sortowania w celu ustalenia priorytetu dopasowania tożsamości.",
    "admin.member.importFieldName"   => "nazwa pola",
    "admin.member.importFieldDisable" => "Kliknij, aby wyłączyć",
    "admin.member.importFieldEnable" => "Kliknij, aby włączyć",
    "admin.member.importBindField"   => "Dopasowanie tożsamości",
    "admin.member.importBindFieldDesc1" => "Zapytanie dopasowuje dane na podstawie określonych pól w kolejności. Jeśli znalezione zostanie istniejące konto, zostanie ono zaktualizowane. W przeciwnym razie utworzone zostanie nowe konto.",
    "admin.member.importBindFieldDesc2" => "Nazwa użytkownika i hasło nie zostaną zaktualizowane podczas aktualizacji, jednak pole hasła nadal będzie musiało zostać wypełnione.",
    "admin.member.importType"        => "Metoda importu",
    "admin.member.importType0"       => "Dodatkowy import",
    "admin.member.importType1"       => "Pełny import",
    "admin.member.importTypeValue"   => "Nieprawidłowa obsługa konta",
    "admin.member.importTypeValueDesc" => "Podczas pełnego importu obsłuż konta, które nie istnieją w aktualnie importowanym pliku.",
    "admin.member.importChangeGroup" => "Migracja do działu",
    "admin.member.importFile"        => "Importuj pliki",
    "admin.member.importFileDesc"    => "Wypełnij plik szablonu zgodnie z wymaganym formatem i prześlij go do odpowiedniego katalogu. Uwaga: Format szablonu może ulec zmianie w zależności od ustawień.",
    "admin.member.selectCsv"         => "Wybierz plik CSV do zaimportowania.",
    "admin.member.importDownData"    => "Eksportuj prąd",
    "admin.member.importDownDataDesc" => "Eksportuj wszystkie bieżące konta w formacie szablonu",
...
<li> Aktualizacja: po pobraniu prześlij i rozpakuj do odpowiedniego folderu z nazwą wtyczki;</li>",
    ...
    "admin.storage.ifDel"            => "Czy na pewno chcesz usunąć bieżące miejsce przechowywania?",
    ...
    "admin.storage.ifRmBakNow"       => "To miejsce przechowywania zawiera dane zapasowe. Czy powinniśmy je usunąć bezpośrednio?",
    "admin.storage.moveErr"          => "Nie można podłączyć magazynu i nie można ukończyć migracji danych.",
    "admin.storage.ifRmErrNow"       => "Nie można połączyć się z pamięcią masową i nie można ukończyć migracji danych. Czy powinniśmy ją usunąć bezpośrednio?",
    ...
    "admin.storage.remove"           => "Usuń pamięć masową",
    ...
    "admin.backup.checkLog"          => "Szczegóły znajdziesz w dzienniku:<br/> dane/temp/log/kopia zapasowa/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "Zadanie tworzenia kopii zapasowej pliku jest wykonywane raz na minutę; zaleca się wykonywanie go poza godzinami pracy.",
 ...
 post_max_size, trzeba zrestartować)",
    ...
    "admin.setting.downloadZipClientDesc" => "Musi mieć możliwość połączenia z siecią zewnętrzną lub witryna musi obsługiwać protokół HTTPS.",
    ...
    "common.code"                    => "kod",
    "common.zoomout"                 => "Kurczyć się",
    "common.zoomin"                  => "powiększać",
    ...
    "common.fail"                    => "Awaria",
    "common.normal"                  => "normalna",
    "common.abnormal"                => "nieprawidłowy",
    "common.error"                   => "Źle",
    "common.remark"                  => "Uwaga",
    "common.result"                  => "wynik",
    "common.ignore"                  => "zaniedbanie",
    ...
    "explorer.zipClientLimit1"       => "Jeśli plik jest większy niż 4 GB, kompresja front-end nie może zostać ukończona. Wybierz pobieranie w partiach lub skorzystaj z klienta.",
    "explorer.zipClientLimit2"       => "Plików większych niż 4 GB nie można kompresować w trybie front-end.",
