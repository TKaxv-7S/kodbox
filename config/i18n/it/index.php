...
<li> Intervallo IP: l'ip corrisponde all'intervallo; ad esempio: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.uploadDataInvalid" => "I dati caricati sono scaduti. Si prega di inviarli nuovamente!",
    ...
    "admin.member.importFailDesc"    => "Successo: [1], Fallimento: [2]",
    ...
    "admin.member.importDisable"     => "Disabilita (Disabilita -1, Abilita -0 o vuoto)",
    "admin.member.importSizeLimit"   => "La dimensione del file ha superato il limite ([1]).",
    "admin.member.importDownErr"     => "Download del file non riuscito!",
    "admin.member.importEmpty"       => "Il file è vuoto!",
    "admin.member.importAllErr"      => "Nessuna informazione di account valida trovata. Si prega di verificare!",
    "admin.member.importPartErr"     => "Alcune informazioni del tuo account non sono corrette. Verificale!",
    "admin.member.importStart"       => "Verifica completata, avvio importazione.",
    "admin.member.importGroupErr"    => "Il reparto è vuoto.",
    "admin.member.importNameErr"     => "Il conto è vuoto",
    "admin.member.importPwdErr"      => "La password è vuota.",
    "admin.member.importGroupAuthErr" => "Le autorizzazioni del dipartimento sono vuote.",
    "admin.member.importSysErr"      => "Errore di sistema",
    "admin.member.importGroupAuthCntErr" => "Il dipartimento e l'autorità non corrispondono",
    "admin.member.importGroupPathErr" => "Il percorso del dipartimento specificato non esiste.",
    "admin.member.importAuthErr"     => "L'autorizzazione specificata non esiste:",
    "admin.member.importGroup1"      => "Archiviazione cloud aziendale / Dipartimento di ricerca e sviluppo / Gruppo di ricerca e sviluppo 2",
    "admin.member.importGroup2"      => "Reparto di gestione e manutenzione dell'archiviazione cloud aziendale",
    "admin.member.importCopyGroupTips" => "Caricamento dei dati del dipartimento in corso, riprova più tardi.",
    "admin.member.importCopyTips"    => "Copia non riuscita, aggiorna la pagina e riprova!",
    "admin.member.importCheckStart"  => "Avviare l'ispezione",
    "admin.member.importCheckRest"   => "Risultati dell'ispezione",
    "admin.member.importSaveRest"    => "Risultati dell'importazione",
    "admin.member.importLineNum"     => "numero di riga",
    "admin.member.importContinue"    => "Continua l'importazione",
    "admin.member.importIDNumber"    => "carta d'identità",
    "admin.member.importUserSize"    => "dimensione dello spazio utente",
    "admin.member.importUserSizeDesc" => "0 rappresenta nessuna restrizione",
    "admin.member.importUserRole"    => "Ruoli e autorizzazioni utente",
    "admin.member.importUserGroup"   => "Reparto utenti",
    "admin.member.importGroupSet"    => "Impostazioni unificate",
    "admin.member.importGroupImport" => "Impostazioni di importazione",
    "admin.member.importGroupDesc"   => "Impostazioni unificate: Seleziona le impostazioni nell'interfaccia per specificare un reparto unificato e le autorizzazioni per tutti gli account importati [0] Impostazioni di importazione: Aggiungi i campi reparto e autorizzazioni al modello. Il campo reparto viene compilato con il percorso completo del reparto (ad esempio,<code>企业网盘/研发部/研发二组</code>) e più campi sono separati da <code>;</code> . Il campo autorizzazioni viene compilato con il nome dell'autorizzazione e più campi sono anch'essi separati da <code>;</code> . Il contenuto dei due campi corrisponde uno a uno.",
    "admin.member.importCopyTool"    => "Strumento di copia",
    "admin.member.importCopyToolDesc" => "Fai clic sul pulsante per aprire la finestra di copia, dove potrai copiare i percorsi dipartimentali e le autorizzazioni necessarie per compilare il modello.",
    "admin.member.importCopyGroup"   => "Copia percorso",
    "admin.member.importCopyGroupDesc" => "Copia il percorso completo del dipartimento selezionato",
    "admin.member.importCopyAuth"    => "Autorizzazione alla copia",
    "admin.member.importCopyAuthDesc" => "Nome dell'autorizzazione di copia",
    "admin.member.importMetaMore"    => "Campi estesi",
    "admin.member.importMetaMoreDesc" => "Aggiungi altri campi personalizzati al file importato",
    "admin.member.importMetaField"   => "Campi personalizzati",
    "admin.member.importMetaFieldDesc" => "Il numero di cellulare e l'indirizzo email sono campi di sistema e vengono utilizzati esclusivamente per l'ordinamento, al fine di determinare la priorità di corrispondenza dell'identità.",
    "admin.member.importFieldName"   => "nome del campo",
    "admin.member.importFieldDisable" => "Fare clic per disattivare",
    "admin.member.importFieldEnable" => "Fare clic per abilitare",
    "admin.member.importBindField"   => "Corrispondenza dell'identità",
    "admin.member.importBindFieldDesc1" => "La query confronta i dati in base ai campi specificati, nell'ordine indicato; se viene trovato un account esistente, questo viene aggiornato; altrimenti, viene creato un nuovo account.",
    "admin.member.importBindFieldDesc2" => "Il nome utente e la password di accesso non verranno aggiornati durante l'aggiornamento, ma il campo della password deve comunque essere compilato.",
    "admin.member.importType"        => "Metodo di importazione",
    "admin.member.importType0"       => "Importazione aggiuntiva",
    "admin.member.importType1"       => "Importazione completa",
    "admin.member.importTypeValue"   => "Gestione account non valida",
    "admin.member.importTypeValueDesc" => "Durante un'importazione completa, gestire gli account che non esistono nel file attualmente importato.",
    "admin.member.importChangeGroup" => "Migrare al dipartimento",
    "admin.member.importFile"        => "Importa file",
    "admin.member.importFileDesc"    => "Si prega di compilare il file modello secondo il formato indicato e di caricarlo nella directory corrispondente; Nota: il formato del modello potrebbe variare a seconda delle impostazioni.",
    "admin.member.selectCsv"         => "Seleziona il file CSV da importare.",
    "admin.member.importDownData"    => "Esportazione corrente",
    "admin.member.importDownDataDesc" => "Esporta tutti i conti correnti in formato modello",
...
<li> Aggiornamento: dopo il download, caricare e decomprimere nella cartella del nome del plug-in corrispondente;</li>",
    ...
    "admin.storage.ifDel"            => "Sei sicuro di voler eliminare i dati attualmente memorizzati?",
    ...
    "admin.storage.ifRmBakNow"       => "Questo spazio di archiviazione contiene dati di backup. Dobbiamo eliminarli direttamente?",
    ...
    "admin.storage.ifRmErrNow"       => "Impossibile connettere il dispositivo di archiviazione e completare la migrazione dei dati. Dobbiamo eliminarlo direttamente?",
    ...
    "admin.storage.remove"           => "Elimina lo spazio di archiviazione",
    ...
    "admin.backup.checkLog"          => "Per i dettagli, consultare il registro:<br/> dati/temp/log/backup/data_corrente__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "L'attività di backup dei file viene eseguita una volta al minuto; si consiglia di eseguirla al di fuori dell'orario lavorativo.",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "admin.setting.downloadZipClientDesc" => "Deve essere in grado di connettersi alla rete esterna oppure il sito deve essere HTTPS.",
    ...
    "common.code"                    => "codice",
    "common.zoomout"                 => "Restringersi",
    "common.zoomin"                  => "ingrandire",
    ...
    "common.abnormal"                => "anormale",
    "common.error"                   => "Errore",
    "common.remark"                  => "Osservazione",
    "common.result"                  => "Risultato",
    "common.ignore"                  => "trascurare",
    ...
    "explorer.zipClientLimit1"       => "Se il file è più grande di 4 GB, la compressione front-end non può essere completata. Si prega di scegliere di scaricare in batch o di utilizzare il client.",
    "explorer.zipClientLimit2"       => "I file più grandi di 4 GB non possono essere compressi nel front-end.",
