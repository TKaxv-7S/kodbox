...
<li> IP range: ip matches within the range; for example: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.uploadDataInvalid" => "The uploaded data has expired. Please resubmit!",
    ...
    "admin.member.importDisable"     => "Disable (Disable -1, Enable -0, or empty)",
    "admin.member.importSizeLimit"   => "The file size exceeded the limit ([1]).",
    "admin.member.importDownErr"     => "File download failed!",
    "admin.member.importEmpty"       => "The file is empty!",
    "admin.member.importAllErr"      => "No valid account information found. Please check!",
    "admin.member.importPartErr"     => "Some account information is incorrect. Please check!",
    "admin.member.importStart"       => "Check complete, begin import.",
    "admin.member.importGroupErr"    => "The department is empty.",
    "admin.member.importNameErr"     => "Account is empty",
    "admin.member.importPwdErr"      => "The password is empty.",
    "admin.member.importGroupAuthErr" => "The department's permissions are empty.",
    "admin.member.importSysErr"      => "System error",
    "admin.member.importGroupAuthCntErr" => "Department and authority do not match",
    "admin.member.importGroupPathErr" => "The specified department path does not exist.",
    "admin.member.importAuthErr"     => "The specified permission does not exist:",
    "admin.member.importGroup1"      => "Enterprise cloud storage / R&amp;D department / R&amp;D Group 2",
    "admin.member.importGroup2"      => "Enterprise cloud storage/Operations and Maintenance Department",
    "admin.member.importCopyGroupTips" => "Department data is loading, please try again later.",
    "admin.member.importCopyTips"    => "Copying failed, please refresh and try again!",
    "admin.member.importCheckStart"  => "Start inspection",
    "admin.member.importCheckRest"   => "Inspection results",
    "admin.member.importSaveRest"    => "Import results",
    "admin.member.importLineNum"     => "Line number",
    "admin.member.importContinue"    => "Continue importing",
    "admin.member.importIDNumber"    => "ID card",
    "admin.member.importUserSize"    => "User space size",
    "admin.member.importUserSizeDesc" => "0 represents no restriction",
    "admin.member.importUserRole"    => "User Roles and Permissions",
    "admin.member.importUserGroup"   => "User's department",
    "admin.member.importGroupSet"    => "Unified settings",
    "admin.member.importGroupImport" => "Import settings",
    "admin.member.importGroupDesc"   => "Unified settings: Select settings in the interface to specify a unified department and permissions for all imported accounts [0] Import settings: Add the department and permissions fields to the template. The department field is filled in with the full path of the department (e.g.,<code>企业网盘/研发部/研发二组</code>), and multiple fields are separated by <code>;</code> . The permissions field is filled in with the permission name, and multiple fields are also separated by <code>;</code> . The contents of the two fields correspond one-to-one.",
    "admin.member.importCopyTool"    => "Copy tool",
    "admin.member.importCopyToolDesc" => "Click the button to open the copy window, where you can copy the required department paths and permissions to fill in the template.",
    "admin.member.importCopyGroup"   => "Copy path",
    "admin.member.importCopyGroupDesc" => "Copy the full path of the selected department",
    "admin.member.importCopyAuth"    => "Copy permission",
    "admin.member.importCopyAuthDesc" => "Copy permission name",
    "admin.member.importMetaMore"    => "Extended fields",
    "admin.member.importMetaMoreDesc" => "Add more custom fields to the imported file",
    "admin.member.importMetaField"   => "Custom fields",
    "admin.member.importMetaFieldDesc" => "Mobile phone number and email address are system fields and are only used for sorting to determine the priority of identity matching.",
    "admin.member.importFieldName"   => "Field name",
    "admin.member.importFieldDisable" => "Click to disable",
    "admin.member.importFieldEnable" => "Click to enable",
    "admin.member.importBindField"   => "Identity matching",
    "admin.member.importBindFieldDesc1" => "The query matches data based on the specified fields in order; if an existing account is found, it is updated; otherwise, a new account is created.",
    "admin.member.importBindFieldDesc2" => "The login username and password will not be updated during the update, but the password field still needs to be filled in.",
    "admin.member.importType"        => "Import method",
    "admin.member.importType0"       => "Additional import",
    "admin.member.importType1"       => "Full import",
    "admin.member.importTypeValue"   => "Invalid account handling",
    "admin.member.importTypeValueDesc" => "During a full import, handle accounts that do not exist in the currently imported file.",
    "admin.member.importChangeGroup" => "Migrate to department",
    "admin.member.importFile"        => "Import files",
    "admin.member.importFileDesc"    => "Please fill in the template file according to the format and upload it to the corresponding directory; Note: The template format may change depending on the settings.",
    "admin.member.selectCsv"         => "Select the CSV file to import.",
    "admin.member.importDownData"    => "Export current",
    "admin.member.importDownDataDesc" => "Export all current accounts in template format",
    ...
    "admin.plugin.typeBuy"           => "Value-added",
...
<li> Update: After downloading, upload and unzip to the corresponding plug-in name folder;</li>",
    ...
    "admin.storage.ifDel"            => "Are you sure you want to delete the current storage?",
    ...
    "admin.storage.ifRmBakNow"       => "This storage contains backup data. Should we delete it directly?",
    "admin.storage.moveErr"          => "The storage cannot be connected and data migration cannot be completed.",
    "admin.storage.ifRmErrNow"       => "The storage cannot be connected, and data migration cannot be completed. Should we delete it directly?",
    ...
    "admin.storage.remove"           => "Delete storage",
    ...
    "admin.backup.checkLog"          => "For details, please see the log:<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "The file backup task runs once per minute; it is recommended to perform it during non-working hours.",
 ...
 post_max_size, need to restart)",
    ...
    "admin.setting.downloadZipClientDesc" => "It needs to be able to connect to the external network, or the site needs to be HTTPS.",
    ...
    "common.code"                    => "Code",
    "common.zoomout"                 => "Shrink",
    "common.zoomin"                  => "Enlarge",
    "common.share"                   => "Share",
    ...
    "explorer.zipClientLimit1"       => "If the file is larger than 4GB, front-end compression cannot be completed. Please choose to download in batches or use the client.",
    "explorer.zipClientLimit2"       => "Files larger than 4GB cannot be compressed at the front end.",
