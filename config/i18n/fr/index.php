...
<li> Plage IP: l'adresse IP correspond à la plage; par exemple: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.uploadDataInvalid" => "Les données téléchargées ont expiré. Veuillez les soumettre à nouveau !",
    ...
    "admin.member.importFailDesc"    => "Succès : [1], Échec : [2]",
    ...
    "admin.member.importDisable"     => "Désactiver (Désactiver -1, Activer -0 ou vide)",
    "admin.member.importSizeLimit"   => "La taille du fichier dépasse la limite ([1]).",
    "admin.member.importDownErr"     => "Le téléchargement du fichier a échoué !",
    "admin.member.importEmpty"       => "Le fichier est vide !",
    "admin.member.importAllErr"      => "Aucune information de compte valide n'a été trouvée. Veuillez vérifier !",
    "admin.member.importPartErr"     => "Certaines informations de compte sont incorrectes. Veuillez vérifier !",
    "admin.member.importStart"       => "Vérification terminée, commencez l'importation.",
    "admin.member.importGroupErr"    => "Le département est vide.",
    "admin.member.importNameErr"     => "Le compte est vide.",
    "admin.member.importPwdErr"      => "Le mot de passe est vide.",
    "admin.member.importGroupAuthErr" => "Les autorisations du département sont inexistantes.",
    "admin.member.importSysErr"      => "Erreur système",
    "admin.member.importGroupAuthCntErr" => "Le département et l'autorité ne correspondent pas.",
    "admin.member.importGroupPathErr" => "Le chemin d'accès au département spécifié n'existe pas.",
    "admin.member.importAuthErr"     => "L'autorisation spécifiée n'existe pas :",
    "admin.member.importGroup1"      => "Stockage cloud d'entreprise / Département R&amp;D / Groupe R&amp;D 2",
    "admin.member.importGroup2"      => "Service de stockage cloud d'entreprise/Opérations et maintenance",
    "admin.member.importCopyGroupTips" => "Les données du département sont en cours de chargement, veuillez réessayer plus tard.",
    "admin.member.importCopyTips"    => "La copie a échoué, veuillez actualiser et réessayer !",
    "admin.member.importCheckStart"  => "Début de l'inspection",
    "admin.member.importCheckRest"   => "Résultats de l'inspection",
    "admin.member.importSaveRest"    => "Résultats d'importation",
    "admin.member.importLineNum"     => "numéro de ligne",
    "admin.member.importContinue"    => "Continuer l'importation",
    "admin.member.importIDNumber"    => "Carte d'identité",
    "admin.member.importUserSize"    => "taille de l'espace utilisateur",
    "admin.member.importUserSizeDesc" => "0 représente l'absence de restriction",
    "admin.member.importUserRole"    => "Rôles et autorisations des utilisateurs",
    "admin.member.importUserGroup"   => "Département des utilisateurs",
    "admin.member.importGroupSet"    => "Paramètres unifiés",
    "admin.member.importGroupImport" => "Paramètres d'importation",
    "admin.member.importGroupDesc"   => "Paramètres unifiés : Sélectionnez les paramètres dans l’interface pour spécifier un service et des autorisations unifiés pour tous les comptes importés [0]. Paramètres d’importation : Ajoutez les champs « Service » et « Autorisations » au modèle. Le champ « Service » doit contenir le chemin complet du service (par exemple,<code>企业网盘/研发部/研发二组</code>). Les champs multiples sont séparés par un point-virgule <code>;</code> ). Le champ « Autorisations » doit contenir le nom de l’autorisation. Les champs multiples sont également séparés par un point-virgule <code>;</code> . Le contenu des deux champs correspond exactement.",
    "admin.member.importCopyTool"    => "Outil de copie",
    "admin.member.importCopyToolDesc" => "Cliquez sur le bouton pour ouvrir la fenêtre de copie, où vous pourrez copier les chemins d'accès et les autorisations des services requis pour remplir le modèle.",
    "admin.member.importCopyGroup"   => "Copier le chemin",
    "admin.member.importCopyGroupDesc" => "Copiez le chemin complet du département sélectionné",
    "admin.member.importCopyAuth"    => "Autorisation de copie",
    "admin.member.importCopyAuthDesc" => "Nom de l'autorisation de copie",
    "admin.member.importMetaMore"    => "Champs étendus",
    "admin.member.importMetaMoreDesc" => "Ajoutez davantage de champs personnalisés au fichier importé",
    "admin.member.importMetaField"   => "Champs personnalisés",
    "admin.member.importMetaFieldDesc" => "Le numéro de téléphone portable et l'adresse e-mail sont des champs système et ne servent qu'au tri pour déterminer la priorité de la correspondance d'identité.",
    "admin.member.importFieldName"   => "nom du champ",
    "admin.member.importFieldDisable" => "Cliquez pour désactiver",
    "admin.member.importFieldEnable" => "Cliquez pour activer",
    "admin.member.importBindField"   => "Correspondance d'identité",
    "admin.member.importBindFieldDesc1" => "La requête fait correspondre les données en fonction des champs spécifiés, dans l'ordre ; si un compte existant est trouvé, il est mis à jour ; sinon, un nouveau compte est créé.",
    "admin.member.importBindFieldDesc2" => "Le nom d'utilisateur et le mot de passe de connexion ne seront pas mis à jour lors de la mise à jour, mais le champ du mot de passe doit tout de même être rempli.",
    "admin.member.importType"        => "Méthode d'importation",
    "admin.member.importType0"       => "Importation supplémentaire",
    "admin.member.importType1"       => "Importation complète",
    "admin.member.importTypeValue"   => "Gestion des comptes invalides",
    "admin.member.importTypeValueDesc" => "Lors d'une importation complète, gérez les comptes qui n'existent pas dans le fichier actuellement importé.",
    "admin.member.importChangeGroup" => "Migration vers le département",
    "admin.member.importFile"        => "Fichiers d'importation",
    "admin.member.importFileDesc"    => "Veuillez remplir le fichier modèle en respectant le format et le télécharger dans le répertoire correspondant ; Remarque : Le format du modèle peut varier en fonction des paramètres.",
    "admin.member.selectCsv"         => "Sélectionnez le fichier CSV à importer.",
    "admin.member.importDownData"    => "Exporter le courant",
    "admin.member.importDownDataDesc" => "Exporter tous les comptes courants au format modèle",
...
<li> Mise à jour: après le téléchargement, téléchargez et décompressez dans le dossier de nom de plug-in correspondant;</li>",
    ...
    "admin.storage.ifDel"            => "Êtes-vous sûr de vouloir supprimer le stockage actuel ?",
    ...
    "admin.storage.ifRmBakNow"       => "Ce stockage contient des données de sauvegarde. Devons-nous le supprimer directement ?",
    "admin.storage.moveErr"          => "Le stockage ne peut pas être connecté et la migration des données ne peut pas être terminée.",
    "admin.storage.ifRmErrNow"       => "Le stockage ne peut être connecté et la migration des données ne peut être effectuée. Devons-nous le supprimer directement ?",
    ...
    "admin.storage.remove"           => "Supprimer le stockage",
    ...
    "admin.backup.checkLog"          => "Pour plus de détails, veuillez consulter le journal :<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "La tâche de sauvegarde des fichiers s'exécute une fois par minute ; il est recommandé de l'effectuer en dehors des heures de travail.",
 ...
 post_max_size, besoin de redémarrer)",
    ...
    "admin.setting.downloadZipClientDesc" => "Il doit pouvoir se connecter au réseau externe, ou le site doit être en HTTPS.",
    ...
    "explorer.zipClientLimit1"       => "Si le fichier dépasse 4 Go, la compression en amont ne peut être effectuée. Veuillez choisir de télécharger par lots ou d'utiliser le client.",
    "explorer.zipClientLimit2"       => "Les fichiers de plus de 4 Go ne peuvent pas être compressés en amont.",
