...
<li> Rango de IP: coincidencias de IP dentro del rango; por ejemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.uploadDataInvalid" => "Los datos cargados han caducado. ¡Vuelva a enviarlos!",
    ...
    "admin.member.importDisable"     => "Deshabilitar (Deshabilitar -1, Habilitar -0 o vacío)",
    "admin.member.importSizeLimit"   => "El tamaño del archivo excede el límite ([1]).",
    "admin.member.importDownErr"     => "¡Error al descargar el archivo!",
    "admin.member.importEmpty"       => "¡El archivo está vacío!",
    "admin.member.importAllErr"      => "No se encontró información de cuenta válida. ¡Por favor, verifique!",
    "admin.member.importPartErr"     => "Algunos datos de la cuenta son incorrectos. ¡Por favor, revíselos!",
    "admin.member.importStart"       => "Verificación completada, iniciar importación.",
    "admin.member.importGroupErr"    => "El departamento está vacío.",
    "admin.member.importNameErr"     => "La cuenta está vacía",
    "admin.member.importPwdErr"      => "La contraseña está vacía.",
    "admin.member.importGroupAuthErr" => "Los permisos del departamento están vacíos.",
    "admin.member.importSysErr"      => "Error del sistema",
    "admin.member.importGroupAuthCntErr" => "El departamento y la autoridad no coinciden.",
    "admin.member.importGroupPathErr" => "La ruta del departamento especificada no existe.",
    "admin.member.importAuthErr"     => "El permiso especificado no existe:",
    "admin.member.importGroup1"      => "Almacenamiento en la nube empresarial / Departamento de I+D / Grupo de I+D 2",
    "admin.member.importGroup2"      => "Departamento de Operaciones y Mantenimiento/Almacenamiento en la nube empresarial",
    "admin.member.importCopyGroupTips" => "Los datos del departamento se están cargando, por favor inténtelo de nuevo más tarde.",
    "admin.member.importCopyTips"    => "¡Error al copiar! Por favor, actualice la página e inténtelo de nuevo.",
    "admin.member.importCheckStart"  => "Iniciar inspección",
    "admin.member.importCheckRest"   => "Resultados de la inspección",
    "admin.member.importSaveRest"    => "Importar resultados",
    "admin.member.importLineNum"     => "número de línea",
    "admin.member.importContinue"    => "Continuar importando",
    "admin.member.importIDNumber"    => "tarjeta de identificación",
    "admin.member.importUserSize"    => "Tamaño del espacio de usuario",
    "admin.member.importUserSizeDesc" => "0 representa ninguna restricción",
    "admin.member.importUserRole"    => "Roles y permisos de usuario",
    "admin.member.importUserGroup"   => "Departamento de usuarios",
    "admin.member.importGroupSet"    => "Configuración unificada",
    "admin.member.importGroupImport" => "Importar configuración",
    "admin.member.importGroupDesc"   => "Configuración unificada: Seleccione la configuración en la interfaz para especificar un departamento y permisos unificados para todas las cuentas importadas [0] Configuración de importación: Agregue los campos de departamento y permisos a la plantilla. El campo de departamento se completa con la ruta completa del departamento (p. ej.,<code>企业网盘/研发部/研发二组</code>), y los campos múltiples se separan con <code>;</code> . El campo de permisos se completa con el nombre del permiso, y los campos múltiples también se separan con <code>;</code> . El contenido de los dos campos se corresponde uno a uno.",
    "admin.member.importCopyTool"    => "Herramienta de copia",
    "admin.member.importCopyToolDesc" => "Haz clic en el botón para abrir la ventana de copia, donde podrás copiar las rutas de departamento y los permisos necesarios para rellenar la plantilla.",
    "admin.member.importCopyGroup"   => "Copiar ruta",
    "admin.member.importCopyGroupDesc" => "Copia la ruta completa del departamento seleccionado.",
    "admin.member.importCopyAuth"    => "Permiso de copia",
    "admin.member.importCopyAuthDesc" => "Copiar nombre de permiso",
    "admin.member.importMetaMore"    => "Campos extendidos",
    "admin.member.importMetaMoreDesc" => "Agregue más campos personalizados al archivo importado.",
    "admin.member.importMetaField"   => "Campos personalizados",
    "admin.member.importMetaFieldDesc" => "El número de teléfono móvil y la dirección de correo electrónico son campos del sistema y solo se utilizan para ordenar y determinar la prioridad de la coincidencia de identidades.",
    "admin.member.importFieldName"   => "nombre del campo",
    "admin.member.importFieldDisable" => "Haz clic para desactivar",
    "admin.member.importFieldEnable" => "Haz clic para habilitar",
    "admin.member.importBindField"   => "Coincidencia de identidad",
    "admin.member.importBindFieldDesc1" => "La consulta compara los datos según los campos especificados en el orden indicado; si encuentra una cuenta existente, la actualiza; de lo contrario, crea una nueva cuenta.",
    "admin.member.importBindFieldDesc2" => "El nombre de usuario y la contraseña no se actualizarán durante la actualización, pero el campo de contraseña aún debe completarse.",
    "admin.member.importType"        => "Método de importación",
    "admin.member.importType0"       => "Importación adicional",
    "admin.member.importType1"       => "Importación completa",
    "admin.member.importTypeValue"   => "Manejo de cuenta no válida",
    "admin.member.importTypeValueDesc" => "Durante una importación completa, gestione las cuentas que no existen en el archivo que se está importando.",
    "admin.member.importChangeGroup" => "Migrar al departamento",
    "admin.member.importFile"        => "Importar archivos",
    "admin.member.importFileDesc"    => "Por favor, rellene el archivo de plantilla según el formato y cárguelo en el directorio correspondiente; Nota: El formato de la plantilla puede variar según la configuración.",
    "admin.member.selectCsv"         => "Seleccione el archivo CSV que desea importar.",
    "admin.member.importDownData"    => "Exportar actual",
    "admin.member.importDownDataDesc" => "Exportar todas las cuentas corrientes en formato de plantilla.",
...
<li> Actualización: después de la descarga, cargue y descomprima en la carpeta de nombre del complemento correspondiente;</li>",
    ...
    "admin.storage.ifDel"            => "¿Está seguro de que desea eliminar el almacenamiento actual?",
    ...
    "admin.storage.ifRmBakNow"       => "Este almacenamiento contiene datos de respaldo. ¿Debemos eliminarlo directamente?",
    "admin.storage.moveErr"          => "El almacenamiento no se puede conectar y la migración de datos no se puede completar.",
    "admin.storage.ifRmErrNow"       => "No se puede conectar el almacenamiento y no se puede completar la migración de datos. ¿Deberíamos eliminarlo directamente?",
    ...
    "admin.storage.remove"           => "Eliminar almacenamiento",
    ...
    "admin.backup.checkLog"          => "Para más detalles, consulte el registro:<br/> datos/temp/registro/copia de seguridad/fecha_actual__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "La tarea de copia de seguridad de archivos se ejecuta una vez por minuto; se recomienda realizarla fuera del horario laboral.",
 ...
 post_max_size, necesita reiniciar)",
    ...
    "admin.setting.downloadZipClientDesc" => "Debe poder conectarse a la red externa o el sitio debe ser HTTPS.",
    ...
    "common.code"                    => "código",
    "common.zoomout"                 => "Encoger",
    "common.zoomin"                  => "agrandar",
    ...
    "explorer.zipClientLimit1"       => "Si el archivo supera los 4 GB, no se podrá realizar la compresión front-end. Elija descargar por lotes o usar el cliente.",
    "explorer.zipClientLimit2"       => "Los archivos de más de 4 GB no se pueden comprimir en la interfaz.",
 ...
 Admite pinyin, coincidencia difusa de la primera letra",
    ...
    "explorer.secret.tips3"          => "Tras la configuración, los permisos del nivel de seguridad son superiores a los permisos del documento (el propietario del documento también está sujeto a los permisos del nivel de seguridad, pero el superadministrador del sistema no está sujeto a esta restricción, y la persona que configuró el nivel de seguridad tampoco).",
