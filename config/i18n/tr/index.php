...
<li> IP aralığı: ip, aralık dahilinde eşleşir; örneğin: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.uploadDataInvalid" => "Yüklenen verilerin süresi dolmuştur. Lütfen yeniden gönderin!",
    ...
    "admin.member.importDisable"     => "Devre dışı bırak (Devre dışı bırak -1, Etkinleştir -0 veya boş bırak)",
    "admin.member.importSizeLimit"   => "Dosya boyutu sınırı aştı ([1]).",
    "admin.member.importDownErr"     => "Dosya indirme başarısız oldu!",
    "admin.member.importEmpty"       => "Dosya boş!",
    "admin.member.importAllErr"      => "Geçerli hesap bilgisi bulunamadı. Lütfen kontrol edin!",
    "admin.member.importPartErr"     => "Hesap bilgilerinde bazı hatalar var. Lütfen kontrol edin!",
    "admin.member.importStart"       => "Kontrol tamamlandı, içe aktarmaya başlayın.",
    "admin.member.importGroupErr"    => "Bölüm boş.",
    "admin.member.importNameErr"     => "Hesap boş.",
    "admin.member.importPwdErr"      => "Parola boş.",
    "admin.member.importGroupAuthErr" => "Bölümün izinleri boş.",
    "admin.member.importSysErr"      => "Sistem hatası",
    "admin.member.importGroupAuthCntErr" => "Departman ve yetki uyuşmuyor.",
    "admin.member.importGroupPathErr" => "Belirtilen departman yolu mevcut değil.",
    "admin.member.importAuthErr"     => "Belirtilen izin mevcut değil:",
    "admin.member.importGroup1"      => "Kurumsal bulut depolama / Ar-Ge departmanı / Ar-Ge Grubu 2",
    "admin.member.importGroup2"      => "Kurumsal bulut depolama/Operasyon ve Bakım Departmanı",
    "admin.member.importCopyGroupTips" => "Departman verileri yükleniyor, lütfen daha sonra tekrar deneyin.",
    "admin.member.importCopyTips"    => "Kopyalama başarısız oldu, lütfen sayfayı yenileyip tekrar deneyin!",
    "admin.member.importCheckStart"  => "Denetime başlayın",
    "admin.member.importCheckRest"   => "Denetim sonuçları",
    "admin.member.importSaveRest"    => "İçe aktarma sonuçları",
    "admin.member.importLineNum"     => "satır numarası",
    "admin.member.importContinue"    => "İçe aktarmaya devam edin",
    "admin.member.importIDNumber"    => "kimlik kartı",
    "admin.member.importUserSize"    => "Kullanıcı alanı boyutu",
    "admin.member.importUserSizeDesc" => "0 herhangi bir kısıtlama olmadığını temsil eder.",
    "admin.member.importUserRole"    => "Kullanıcı Rolleri ve İzinleri",
    "admin.member.importUserGroup"   => "Kullanıcının departmanı",
    "admin.member.importGroupSet"    => "Birleşik ayarlar",
    "admin.member.importGroupImport" => "Ayarları içe aktar",
    "admin.member.importGroupDesc"   => "Birleşik ayarlar: İçe aktarılan tüm hesaplar için birleşik bir departman ve izinler belirtmek üzere arayüzdeki ayarları seçin [0] İçe aktarma ayarları: Şablona departman ve izin alanlarını ekleyin. Departman alanı, departmanın tam yoluyla doldurulur (örneğin,<code>企业网盘/研发部/研发二组</code>) ve birden fazla alan noktalı virgülle ayrılır <code>;</code> İzin alanı, izin adıyla doldurulur ve birden fazla alan da noktalı virgülle ayrılır <code>;</code> İki alanın içeriği bire bir karşılık gelir.",
    "admin.member.importCopyTool"    => "Kopyalama aracı",
    "admin.member.importCopyToolDesc" => "Şablona eklemek için gerekli departman yollarını ve izinlerini kopyalayabileceğiniz kopyalama penceresini açmak için düğmeye tıklayın.",
    "admin.member.importCopyGroup"   => "Yolu kopyala",
    "admin.member.importCopyGroupDesc" => "Seçilen departmanın tam yolunu kopyalayın.",
    "admin.member.importCopyAuth"    => "Kopyalama izni",
    "admin.member.importCopyAuthDesc" => "Kopyala izin adı",
    "admin.member.importMetaMore"    => "Genişletilmiş alanlar",
    "admin.member.importMetaMoreDesc" => "İçe aktarılan dosyaya daha fazla özel alan ekleyin.",
    "admin.member.importMetaField"   => "Özel alanlar",
    "admin.member.importMetaFieldDesc" => "Cep telefonu numarası ve e-posta adresi sistem alanlarıdır ve yalnızca kimlik eşleştirme önceliğini belirlemek için sıralama amacıyla kullanılır.",
    "admin.member.importFieldName"   => "alan adı",
    "admin.member.importFieldDisable" => "Devre dışı bırakmak için tıklayın",
    "admin.member.importFieldEnable" => "Etkinleştirmek için tıklayın",
    "admin.member.importBindField"   => "Kimlik eşleştirme",
    "admin.member.importBindFieldDesc1" => "Sorgu, belirtilen alanlara göre verileri sırayla eşleştirir; mevcut bir hesap bulunursa güncellenir; aksi takdirde yeni bir hesap oluşturulur.",
    "admin.member.importBindFieldDesc2" => "Güncelleme sırasında giriş kullanıcı adı ve şifresi güncellenmeyecektir, ancak şifre alanının yine de doldurulması gerekmektedir.",
    "admin.member.importType"        => "İçe aktarma yöntemi",
    "admin.member.importType0"       => "Ek ithalat",
    "admin.member.importType1"       => "Tam ithalat",
    "admin.member.importTypeValue"   => "Geçersiz hesap işlemleri",
    "admin.member.importTypeValueDesc" => "Tam içe aktarma işlemi sırasında, şu anda içe aktarılan dosyada bulunmayan hesapları ele alın.",
    "admin.member.importChangeGroup" => "Bölüme geçiş yap",
    "admin.member.importFile"        => "Dosyaları içe aktar",
    "admin.member.importFileDesc"    => "Lütfen şablon dosyasını belirtilen formata uygun olarak doldurun ve ilgili klasöre yükleyin; Not: Şablon formatı ayarlara bağlı olarak değişebilir.",
    "admin.member.selectCsv"         => "İçe aktarmak istediğiniz CSV dosyasını seçin.",
    "admin.member.importDownData"    => "Mevcut ihracat",
    "admin.member.importDownDataDesc" => "Mevcut tüm hesapları şablon formatında dışa aktarın",
...
<li> Güncelleme: İndirdikten sonra, ilgili eklenti adı klasörüne yükleyin ve açın;</li>",
    ...
    "admin.storage.ifDel"            => "Mevcut depolama alanını silmek istediğinizden emin misiniz?",
    ...
    "admin.storage.ifRmBakNow"       => "Bu depolama alanı yedek veriler içeriyor. Doğrudan silmeli miyiz?",
    "admin.storage.moveErr"          => "Depolama bağlanamıyor ve veri taşıma işlemi tamamlanamıyor.",
    "admin.storage.ifRmErrNow"       => "Depolama birimine bağlantı kurulamıyor ve veri geçişi tamamlanamıyor. Doğrudan silmeli miyiz?",
    ...
    "admin.storage.remove"           => "Depolama alanını sil",
    ...
    "admin.backup.checkLog"          => "Ayrıntılar için lütfen kayıtlara bakın:<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "Dosya yedekleme görevi dakikada bir çalışır; bu işlemin mesai saatleri dışında yapılması önerilir.",
 ...
 post_max_size, yeniden başlatmanız gerekiyor)",
    ...
    "admin.setting.downloadZipClientDesc" => "Sitenin harici ağa bağlanabilmesi veya HTTPS desteğine sahip olması gerekiyor.",
    ...
    "common.code"                    => "kod",
    "common.zoomout"                 => "Çekmek",
    "common.zoomin"                  => "büyütmek",
    "common.share"                   => "hisse",
    "common.search"                  => "Arama",
    "common.query"                   => "Sormak",
    "common.delete"                  => "Sil",
    ...
    "common.enable"                  => "Olanak vermek",
    "common.disable"                 => "Devre Dışı",
    "common.continue"                => "sürdürmek",
    ...
    "common.error"                   => "hata",
    "common.remark"                  => "Açıklama",
    "common.result"                  => "sonuç",
    "common.ignore"                  => "ihmal etmek",
    ...
    "explorer.zipClientLimit1"       => "Dosya 4 GB'tan büyükse, ön uç sıkıştırma işlemi tamamlanamaz. Lütfen dosyaları parça parça indirmeyi veya istemciyi kullanmayı tercih edin.",
    "explorer.zipClientLimit2"       => "4 GB'den büyük dosyalar ön uçta sıkıştırılamaz.",
