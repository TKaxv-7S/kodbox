...
<li>IP区间段: ip在区间内则匹配;例如:192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.uploadDataInvalid" => "上传数据已失效，请重新提交！",
    ...
    "admin.member.importDisable"     => "禁用(禁用-1,启用-0或空)",
    "admin.member.importSizeLimit"   => "文件大小超出限制（[1]）",
    "admin.member.importDownErr"     => "文件下载失败！",
    "admin.member.importEmpty"       => "文件内容为空！",
    "admin.member.importAllErr"      => "没有有效的账号信息，请检查！",
    "admin.member.importPartErr"     => "部分账号信息异常，请检查！",
    "admin.member.importStart"       => "检查完成，开始导入",
    "admin.member.importGroupErr"    => "所在部门为空",
    "admin.member.importNameErr"     => "账号为空",
    "admin.member.importPwdErr"      => "密码为空",
    "admin.member.importGroupAuthErr" => "所在部门权限为空",
    "admin.member.importSysErr"      => "系统错误",
    "admin.member.importGroupAuthCntErr" => "所在部门和权限不匹配",
    "admin.member.importGroupPathErr" => "指定的部门路径不存在",
    "admin.member.importAuthErr"     => "指定的权限不存在：",
    "admin.member.importGroup1"      => "企业网盘/研发部/研发二组",
    "admin.member.importGroup2"      => "企业网盘/运维部",
    "admin.member.importCopyGroupTips" => "部门数据加载中，请稍后重试",
    "admin.member.importCopyTips"    => "复制失败，请刷新重试！",
    "admin.member.importCheckStart"  => "开始检查",
    "admin.member.importCheckRest"   => "检查结果",
    "admin.member.importSaveRest"    => "导入结果",
    "admin.member.importLineNum"     => "行号",
    "admin.member.importContinue"    => "继续导入",
    "admin.member.importIDNumber"    => "身份证",
    "admin.member.importUserSize"    => "用户空间大小",
    "admin.member.importUserSizeDesc" => "0代表不限制",
    "admin.member.importUserRole"    => "用户角色权限",
    "admin.member.importUserGroup"   => "用户所在部门",
    "admin.member.importGroupSet"    => "统一设置",
    "admin.member.importGroupImport" => "导入设置",
    "admin.member.importGroupDesc"   => "统一设置：在界面选择设置，为所有导入账号指定统一的部门和权限[0]导入设置：在模板增加所在部门及权限字段，所在部门填写部门全路径（如<code>企业网盘/研发部/研发二组</code>），多个以<code>;</code>分隔；所在部门权限填写权限名称，多个同样以<code>;</code>分隔，两者内容一一对应。",
    "admin.member.importCopyTool"    => "复制工具",
    "admin.member.importCopyToolDesc" => "点击按钮打开复制窗口，可复制所需部门路径和权限，用于填写模板",
    "admin.member.importCopyGroup"   => "复制路径",
    "admin.member.importCopyGroupDesc" => "复制所选部门全路径",
    "admin.member.importCopyAuth"    => "复制权限",
    "admin.member.importCopyAuthDesc" => "复制权限名称",
    "admin.member.importMetaMore"    => "扩展字段",
    "admin.member.importMetaMoreDesc" => "在导入文件中添加更多自定义字段",
    "admin.member.importMetaField"   => "自定义字段",
    "admin.member.importMetaFieldDesc" => "手机号、邮箱为系统字段，仅参与排序，用于身份匹配优先顺序",
    "admin.member.importFieldName"   => "字段名",
    "admin.member.importFieldDisable" => "点击禁用",
    "admin.member.importFieldEnable" => "点击启用",
    "admin.member.importBindField"   => "身份匹配",
    "admin.member.importBindFieldDesc1" => "按指定字段先后顺序进行查询匹配，查询到已存在账号则进行更新，否则新增",
    "admin.member.importBindFieldDesc2" => "更新时不会更新登录账号和密码，但密码字段仍需填写",
    "admin.member.importType"        => "导入方式",
    "admin.member.importType0"       => "追加导入",
    "admin.member.importType1"       => "全量导入",
    "admin.member.importTypeValue"   => "失效账号处理",
    "admin.member.importTypeValueDesc" => "全量导入时，对不存在于当前导入文件中的账号进行处理",
    "admin.member.importChangeGroup" => "迁移到部门",
    "admin.member.importFile"        => "导入文件",
    "admin.member.importFileDesc"    => "请按照模板文件格式填写后上传到对应目录；注意：模板格式会随设置发生变化",
    "admin.member.selectCsv"         => "选择待导入CSV文件",
    "admin.member.importDownData"    => "导出当前",
    "admin.member.importDownDataDesc" => "以模版格式导出当前所有账号",
...
<li>更新: 下载后上传解压覆盖到到对应插件名文件夹;</li>",
    ...
    "admin.backup.checkLog"          => "详情可查看日志：<br/>data/temp/log/backup/当天日期__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "文件备份任务每分钟执行一次，建议选择在非工作时间段进行",
...
post_max_size,需要重启)",
    ...
    "explorer.zipClientLimit1"       => "文件大于4GB，无法完成前端压缩，请选择分批或使用客户端下载",
    "explorer.zipClientLimit2"       => "文件大于4GB，无法完成前端压缩",
...
支持拼音、首字母模糊匹配",
    ...
    "explorer.secret.tips3"          => "设置后密级权限高于文档权限(文档拥有者也受密级权限控制,系统超级管理员不受该限制,密级设置者自己不受该限制)",
