...
<li> Intervalo de IP: correspondências de ip dentro do intervalo; por exemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.member.uploadDataInvalid" => "Os dados enviados expiraram. Por favor, envie novamente!",
    ...
    "admin.member.importFailDesc"    => "Sucesso: [1], Fracasso: [2]",
    ...
    "admin.member.importDisable"     => "Desativar (Desativar -1, Ativar -0 ou vazio)",
    "admin.member.importSizeLimit"   => "O tamanho do arquivo excedeu o limite ([1]).",
    "admin.member.importDownErr"     => "O download do arquivo falhou!",
    "admin.member.importEmpty"       => "O arquivo está vazio!",
    "admin.member.importAllErr"      => "Nenhuma informação de conta válida encontrada. Por favor, verifique!",
    "admin.member.importPartErr"     => "Algumas informações da conta estão incorretas. Por favor, verifique!",
    "admin.member.importStart"       => "Verificação concluída, iniciar importação.",
    "admin.member.importGroupErr"    => "O departamento está vazio.",
    "admin.member.importNameErr"     => "A conta está vazia",
    "admin.member.importPwdErr"      => "A senha está vazia.",
    "admin.member.importGroupAuthErr" => "As permissões do departamento estão vazias.",
    "admin.member.importSysErr"      => "Erro do sistema",
    "admin.member.importGroupAuthCntErr" => "Departamento e autoridade não coincidem",
    "admin.member.importGroupPathErr" => "O caminho do departamento especificado não existe.",
    "admin.member.importAuthErr"     => "A permissão especificada não existe:",
    "admin.member.importGroup1"      => "Armazenamento em nuvem empresarial / Departamento de P&amp;D / Grupo de P&amp;D 2",
    "admin.member.importGroup2"      => "Departamento de Armazenamento em Nuvem Empresarial/Operações e Manutenção",
    "admin.member.importCopyGroupTips" => "Os dados do departamento estão sendo carregados. Por favor, tente novamente mais tarde.",
    "admin.member.importCopyTips"    => "A cópia falhou. Atualize a página e tente novamente!",
    "admin.member.importCheckStart"  => "Iniciar inspeção",
    "admin.member.importCheckRest"   => "Resultados da inspeção",
    "admin.member.importSaveRest"    => "Resultados da importação",
    "admin.member.importLineNum"     => "número da linha",
    "admin.member.importContinue"    => "Continuar a importação",
    "admin.member.importIDNumber"    => "carteira de identidade",
    "admin.member.importUserSize"    => "Tamanho do espaço do usuário",
    "admin.member.importUserSizeDesc" => "0 representa nenhuma restrição",
    "admin.member.importUserRole"    => "Funções e permissões do usuário",
    "admin.member.importUserGroup"   => "Departamento do usuário",
    "admin.member.importGroupSet"    => "Configurações unificadas",
    "admin.member.importGroupImport" => "Importar configurações",
    "admin.member.importGroupDesc"   => "Configurações unificadas: Selecione as configurações na interface para especificar um departamento e permissões unificados para todas as contas importadas [0] Configurações de importação: Adicione os campos de departamento e permissões ao modelo. O campo de departamento é preenchido com o caminho completo do departamento (por exemplo,<code>企业网盘/研发部/研发二组</code>), e vários campos são separados por <code>;</code> . O campo de permissões é preenchido com o nome da permissão, e vários campos também são separados por <code>;</code> . O conteúdo dos dois campos corresponde um a um.",
    "admin.member.importCopyTool"    => "Ferramenta de cópia",
    "admin.member.importCopyToolDesc" => "Clique no botão para abrir a janela de cópia, onde você poderá copiar os caminhos e permissões de departamento necessários para preencher o modelo.",
    "admin.member.importCopyGroup"   => "Copiar caminho",
    "admin.member.importCopyGroupDesc" => "Copie o caminho completo do departamento selecionado.",
    "admin.member.importCopyAuth"    => "Permissão para copiar",
    "admin.member.importCopyAuthDesc" => "Copiar nome da permissão",
    "admin.member.importMetaMore"    => "Campos estendidos",
    "admin.member.importMetaMoreDesc" => "Adicione mais campos personalizados ao arquivo importado.",
    "admin.member.importMetaField"   => "Campos personalizados",
    "admin.member.importMetaFieldDesc" => "O número de telefone celular e o endereço de e-mail são campos do sistema e são usados apenas para classificação, a fim de determinar a prioridade da correspondência de identidade.",
    "admin.member.importFieldName"   => "nome do campo",
    "admin.member.importFieldDisable" => "Clique para desativar",
    "admin.member.importFieldEnable" => "Clique para ativar",
    "admin.member.importBindField"   => "Correspondência de identidade",
    "admin.member.importBindFieldDesc1" => "A consulta compara os dados com base nos campos especificados, na ordem em que aparecem; se uma conta existente for encontrada, ela será atualizada; caso contrário, uma nova conta será criada.",
    "admin.member.importBindFieldDesc2" => "O nome de usuário e a senha de login não serão atualizados durante a atualização, mas o campo de senha ainda precisa ser preenchido.",
    "admin.member.importType"        => "Método de importação",
    "admin.member.importType0"       => "Importação adicional",
    "admin.member.importType1"       => "Importação completa",
    "admin.member.importTypeValue"   => "Tratamento de contas inválidas",
    "admin.member.importTypeValueDesc" => "Durante uma importação completa, trate as contas que não existem no arquivo importado atualmente.",
    "admin.member.importChangeGroup" => "Migrar para o departamento",
    "admin.member.importFile"        => "Arquivos de importação",
    "admin.member.importFileDesc"    => "Preencha o arquivo de modelo de acordo com o formato e faça o upload para o diretório correspondente; Observação: o formato do modelo pode variar dependendo das configurações.",
    "admin.member.selectCsv"         => "Selecione o arquivo CSV que deseja importar.",
    "admin.member.importDownData"    => "Exportar corrente",
    "admin.member.importDownDataDesc" => "Exporte todas as contas correntes em formato de modelo.",
...
<li> Atualizar: Após baixar, carregue e descompacte para a pasta de nome do plug-in correspondente;</li>",
    ...
    "admin.storage.ifDel"            => "Tem certeza de que deseja excluir o armazenamento atual?",
    ...
    "admin.storage.ifRmBakNow"       => "Este armazenamento contém dados de backup. Devemos excluí-lo diretamente?",
    "admin.storage.moveErr"          => "O armazenamento não pode ser conectado e a migração de dados não pode ser concluída.",
    "admin.storage.ifRmErrNow"       => "Não foi possível conectar o dispositivo de armazenamento e a migração de dados não pôde ser concluída. Devemos excluí-lo diretamente?",
    ...
    "admin.storage.remove"           => "Excluir armazenamento",
    ...
    "admin.backup.checkLog"          => "Para mais detalhes, consulte o registro:<br/> data/temp/log/backup/current_date__log.php",
    ...
    "admin.backup.optionFileTimeDesc" => "A tarefa de backup de arquivos é executada uma vez por minuto; recomenda-se realizá-la fora do horário de expediente.",
 ...
 post_max_size, precisa reiniciar)",
    ...
    "admin.setting.downloadZipClientDesc" => "É necessário que o site consiga se conectar à rede externa ou que utilize o protocolo HTTPS.",
    ...
    "explorer.zipClientLimit1"       => "Se o arquivo for maior que 4 GB, a compressão inicial não poderá ser concluída. Nesse caso, escolha baixar em lotes ou usar o cliente.",
    "explorer.zipClientLimit2"       => "Arquivos maiores que 4 GB não podem ser compactados na etapa inicial.",
